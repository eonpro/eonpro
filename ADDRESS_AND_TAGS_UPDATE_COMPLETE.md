...
## Summary
Successfully fixed the address redundancy at the top of patient profiles and added colorful hashtags that use consistent colors.

## Changes Made

### 1. Address Display Fix (Top of Profile)
**Problem**: The address at the top of the patient profile was showing redundant city/state/zip information.
