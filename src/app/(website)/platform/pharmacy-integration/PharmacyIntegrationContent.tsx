      ...
      <div className="p-4">
        {[
          ...
          <div key={rx.n} className="flex items-center justify-between border-t border-gray-100 py-3 first:border-0 first:pt-0">
            ...
            <span className="rounded-full px-2 py-0.5 text-[10px] font-semibold" style={{ color: rx.sc, backgroundColor: `${rx.sc}15` }}>{rx.st}</span>
          </div>
        ))}
      ...
      features={[
        {
          ...
          description: 'Prescriptions flow from provider to pharmacy electronically. DoseSpot integration handles PDMP checks and controlled substance compliance.',
        },
        {
          title: 'Automated Fulfillment',
          description: 'Rx queue management with status tracking from verification through compounding, packaging, and shipping.',
        },
        {
          title: 'FedEx Shipment Tracking',
          description: 'Real-time package tracking with automated patient notifications at each milestone — shipped, in transit, and delivered.',
        },
        {
          title: 'Duplicate Detection',
          description: 'Automatic detection of duplicate prescriptions to prevent errors and ensure patient safety across providers.',
        },
        {
          title: 'Photo Verification',
          description: 'Package photos captured at fulfillment for quality assurance and dispute resolution. Stored securely with audit trail.',
        },
        {
          title: 'Refill Management',
          description: 'Automated refill reminders, provider approval workflows, and patient self-service refill requests from the portal.',
        },
      ]}
    />
  );
