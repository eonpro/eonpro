      ...
      features={[
        {
          ...
          description: 'Record or type notes, and the AI Scribe generates structured Subjective, Objective, Assessment, and Plan sections in seconds.',
        },
        {
          title: 'E-Prescribing',
          description: 'DoseSpot-integrated prescribing with drug-drug interaction checks, formulary lookup, and EPCS for controlled substances.',
        },
        {
          title: 'Telehealth Integration',
          description: 'Launch Zoom video visits directly from the patient chart. Pre-visit intake data is surfaced automatically.',
        },
        {
          title: 'Drug Reference & ICD Codes',
          description: 'Search FDA drug database and ICD-10 codes inline. Auto-populate diagnoses and medication details.',
        },
        {
          title: 'Clinical Calculators',
          description: 'BMI, GFR, metabolic rate, and dosing calculators built right into the workflow — no external tools needed.',
        },
        {
          title: 'Patient Timeline',
          description: 'Complete chronological view of encounters, prescriptions, lab results, messages, and vitals for each patient.',
        },
      ]}
    />
  );
