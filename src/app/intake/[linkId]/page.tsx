...
export default function IntakeFormPage({ params }: { params: Promise<{ linkId: string }> }) {
      ...
      case 'date':
        return (
          <input
            ...
            className={`w-full rounded border p-2 ${hasError ? 'border-red-500' : 'border-gray-300'}`}
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
          <div className="text-center">
            ...
            <p className="mt-4 text-sm text-gray-500">You may close this window.</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
          <div className="text-center">
            ...
            <h2 className="mb-2 text-xl font-semibold">Form Already Completed</h2>
            <p className="text-gray-600">
              This form was submitted on {new Date(form.completedAt!).toLocaleDateString()}
            </p>
          </div>
        </div>
      </div>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full rounded border p-2 ${validationErrors[-1] ? 'border-red-500' : 'border-gray-300'}`}
                      required
                    />
                    {validationErrors[-1] && (
                      <p className="mt-1 text-sm text-red-500">{validationErrors[-1]}</p>
                    )}
                  </div>
                  <div>
