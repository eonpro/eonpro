...
export function ThankYouPage({
  ...
  const getAddonPrice = (addon: string) => {
    if (addon.toLowerCase().includes('nausea')) return 39.0;
    if (addon.toLowerCase().includes('fat')) return 99.0;
    return 0;
  };

  const actualShippingCost = expeditedShipping ? 25.0 : 0;
  ...
  const t =
    language === 'es'
      ? {
          ...
          providerReview:
            'Su información será compartida con un proveedor médico con licencia en su estado para determinar si califica para el tratamiento.',
          ...
          step4:
            'Recibirá información de seguimiento una vez que la farmacia dispense su tratamiento.',
      ...
      : {
          ...
          providerReview:
            'Your information will be shared with licensed medical provider in your state to determine if you qualify for treatment.',
          ...
          step4:
            'You will receive tracking information once the pharmacy dispensed your treatment.',
  ...
  const formatPlanName = () => {
    if (plan?.toLowerCase().includes('3') || plan?.toLowerCase().includes('three'))
      return `3 ${t.monthPackage}`;
    if (plan?.toLowerCase().includes('6') || plan?.toLowerCase().includes('six'))
      return `6 ${t.monthPackage}`;
    if (plan?.toLowerCase().includes('one'))
      return language === 'es' ? 'Compra Única' : 'One-time Purchase';
      ...
      <div className="mx-auto max-w-2xl px-4">
        ...
        >
          ...
          >
            ...
            <p className="mx-auto mb-6 max-w-md text-sm text-gray-800">{t.providerReview}</p>
          ...
          <div className="p-6" style={{ padding: '24px' }}>
            ...
            <div style={{ marginBottom: '16px' }}>
              <h3 className="text-sm font-semibold text-gray-700" style={{ marginBottom: '12px' }}>
                {t.plan}
              </h3>
              <div
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          borderRadius: '8px',
                          padding: '16px',
                          marginBottom: index < addons.length - 1 ? '12px' : '0',
                        }}
                      >
                        <div
                          style={{
                        ...
                        >
                          ...
                          <span className="text-sm font-semibold">${addonPrice.toFixed(2)}</span>
                        </div>
                      </div>
                    );
                  })}
            ...
            {/* Total Section */}
            <div
              style={{ borderTop: '1px solid #e5e7eb', paddingTop: '16px', marginBottom: '16px' }}
            >
              <div
            ...
            {shippingAddress && (
              <div style={{ borderTop: '1px solid #e5e7eb', paddingTop: '16px' }}>
                <h3 className="text-sm font-semibold text-gray-700" style={{ marginBottom: '8px' }}>
                  {t.shippingAddress}
                </h3>
          ...
          {/* What's Next Section */}
          <div
            className="mx-6 mb-6 rounded-lg p-6"
            style={{ backgroundColor: accentColor, width: 'calc(100% - 48px)' }}
          >
            <h3 className="mb-4 text-lg font-bold" style={{ marginBottom: '16px' }}>
              {t.whatsNext}
            </h3>
            <ul
              className="text-sm"
              style={{ listStyleType: 'disc', paddingLeft: '20px', lineHeight: '1.8' }}
            >
          ...
          >
            <p>{t.questions}</p>
            <p>
              <a href="mailto:support@eonmeds.com" style={{ fontWeight: '600', color: '#111827' }}>
                support@eonmeds.com
              </a>
            </p>
            <p>
              {t.orCall}{' '}
              <a href="tel:+18889206025" style={{ fontWeight: '600', color: '#111827' }}>
                1-888-920-6025
              </a>
            </p>
          </div>
        ...
        <div className="mt-6 space-y-3">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-full bg-black px-6 py-3 font-medium text-white transition-colors hover:bg-gray-800"
          >
          ...
          <button
            ...
            className="w-full rounded-full border-2 border-black bg-white px-6 py-3 font-medium text-black transition-colors hover:bg-gray-100"
          >
