...
export function PaymentForm({
  ...
  const isSubscriptionByPlanName = Boolean(
    planId &&
  ...
  const translations = {
    ...
    es: {
      ...
      cardSaved:
        'Para modificar o cancelar su plan de tratamiento, visite www.eonmeds.com/cancellations',
    },
  };
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        <h3 className="mb-4 text-lg font-semibold">{t.paymentTitle}</h3>

        {/* Subscription Information */}
        {showSubscriptionNotice ? (
          <div
            className="mb-4 rounded-lg border p-4"
            style={{ backgroundColor: '#efece7', borderColor: '#d4cec4' }}
          >
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm">
                <p className="mb-1 font-medium" style={{ color: '#3d342a' }}>
                  {t.subscriptionInfo}
                </p>
                <p style={{ color: '#5a4d3f' }}>{t.subscriptionNote}</p>
                <p className="mt-2 text-xs" style={{ color: '#5a4d3f' }}>
                  {t.cardSaved}
                </p>
              </div>
            </div>
        ...
        <div className="mt-4 text-center text-sm text-gray-600">
          ...
          <p className="mt-1 text-xs">{t.acceptedCards}</p>
        </div>
        ...
        <button
          ...
          className={`mt-6 w-full rounded-full px-6 py-4 font-semibold text-white transition-all ${
            isProcessing || !stripe
