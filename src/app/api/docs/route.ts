 ...
 * Requires authentication (admin or super_admin) to avoid exposing internal surface area.
 */
export const GET = withAuth(
  async (req: NextRequest) => {
    ...
    return NextResponse.json(
    {
      ...
      version: '2.0.0',
      description:
        'Enterprise healthcare platform for patient management, prescriptions, and telehealth',
      baseUrl: `${baseUrl}/api`,

      documentation: {
        webhookGuide:
          'https://github.com/eonpro/eonpro/blob/main/docs/WEBHOOK_INTEGRATION_GUIDE.md',
