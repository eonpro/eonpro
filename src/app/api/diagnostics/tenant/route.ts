      ...
      if (patient) {
        ...
        const resolvedBLOODWORK_LABS_raw =
          resolvedRaw && typeof resolvedRaw === 'object' && !Array.isArray(resolvedRaw)
            ...
            : undefined;
        const resolvedBLOODWORK_LABS_evaluated = clinic
          ? getClinicFeatureBoolean(resolvedRaw, 'BLOODWORK_LABS', true)
          : null;
        patientProof = {
          patient: {
            id: patient.id,
            ...
            clinic: patient.clinic
              ? {
                  ...
                  features_BLOODWORK_LABS: {
                    ...
                    rawType:
                      patientBLOODWORK_LABS === undefined
                        ? 'undefined'
                        : typeof patientBLOODWORK_LABS,
          ...
          resolved: clinic
            ? {
                ...
                features_BLOODWORK_LABS: {
                  ...
                  rawType:
                    resolvedBLOODWORK_LABS_raw === undefined
                      ? 'undefined'
                      : typeof resolvedBLOODWORK_LABS_raw,
        ...
        const pt = patientProof as {
          patient: { clinicId: number | null };
          resolved: { clinicId: number } | null;
          crossTenant: boolean;
        };
        ...
        } else if (pt.patient.clinicId === 8 && pRaw === false) {
          (patientProof as Record<string, unknown>).verdict =
