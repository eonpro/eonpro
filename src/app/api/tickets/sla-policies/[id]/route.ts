  ...
  async (request, user, { params } = {} as RouteParams) => {
    try {
      ...
      const policy = await prisma.slaPolicyConfig.update({
        ...
        data: {
          ...
          ...(body.nextResponseMinutes !== undefined
            ...
            : {}),
          ...(body.businessHoursId !== undefined
          ...
          ...(body.respectBusinessHours !== undefined
            ...
            : {}),
          ...(body.escalateOnBreach !== undefined
            ? { escalateOnBreach: body.escalateOnBreach }
            : {}),
          ...(body.warningThresholdPct !== undefined
      ...
      return handleApiError(error, {
        route: `PATCH /api/tickets/sla-policies/${(await params).id}`,
      });
    }
  }
);
...
export const DELETE = withAuth<RouteParams>(
  async (request, user, { params } = {} as RouteParams) => {
    try {
      ...
      return handleApiError(error, {
        route: `DELETE /api/tickets/sla-policies/${(await params).id}`,
      });
    }
  }
);
