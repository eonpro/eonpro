  ...
  async (req: NextRequest, user: AuthUser) => {
    try {
      ...
      return handleApiError(error, {
        context: { route: 'POST /api/patient-portal/push-subscription' },
      });
    }
  },
  { roles: ['patient'] }
...
export const DELETE = withAuth(
  async (req: NextRequest, user: AuthUser) => {
    try {
      ...
      return handleApiError(error, {
        context: { route: 'DELETE /api/patient-portal/push-subscription' },
      });
    }
  },
  { roles: ['patient'] }
...
export const GET = withAuth(
  async (req: NextRequest, user: AuthUser) => {
    try {
      ...
      return handleApiError(error, {
        context: { route: 'GET /api/patient-portal/push-subscription' },
      });
    }
  },
  { roles: ['patient'] }
