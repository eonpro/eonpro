...
export const PATCH = withAuthParams(async (
  ...
  try {
    ...
    if (initialFlatAmountCents !== undefined) updateData.initialFlatAmountCents = initialFlatAmountCents;
    if (recurringPercentBps !== undefined) updateData.recurringPercentBps = recurringPercentBps;
    if (recurringFlatAmountCents !== undefined) updateData.recurringFlatAmountCents = recurringFlatAmountCents;
