  ...
  try {
    ...
    const formattedProducts = products.data.map(product => {
      ...
      return {
        ...
        defaultPrice: defaultPrice ? {
          ...
          amountFormatted: defaultPrice.unit_amount ? formatCurrency(defaultPrice.unit_amount) : 'N/A',
    ...
    return NextResponse.json({
      ...
      pagination: {
        ...
        limit,
        ...(formattedProducts.length > 0 && { lastId: formattedProducts[formattedProducts.length - 1].id }),
      },
