    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6 bg-[#efece7]">
        <div className="max-w-md w-full text-center bg-white rounded-2xl shadow-lg p-8">
          ...
          <p className="text-gray-600 mb-6">Your admin session has expired. Please log in again.</p>
          <Link
    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-[#efece7]">
      <div className="max-w-md w-full text-center bg-white rounded-2xl shadow-lg p-8">
        ...
        <p className="text-gray-600 mb-6">
          An error occurred in the admin dashboard. Our team has been notified.
        </p>
