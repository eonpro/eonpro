...
export default function AffiliateReportsPage() {
  ...
  const handleExport = (type: 'affiliates' | 'commissions' | '1099') => {
    ...
    if (type === 'affiliates') {
      ...
      filename = `affiliate-report-${period}-${calendarTodayServer()}.csv`;
      ...
      filename = `commission-trends-${period}-${calendarTodayServer()}.csv`;
    } else if (type === '1099') {
      ...
      filename = `1099-summary-${calendarTodayServer()}.csv`;
    }
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-xl bg-white p-5 shadow-sm">
          ...
          <a
            ...
            className="mt-4 inline-flex items-center gap-2 text-sm text-[var(--brand-primary)] hover:text-[var(--brand-primary)]"
          >
