  ...
  links: [
    {
      id: '1',
      name: 'Main Link',
      url: 'https://eonpro.com/r/SARAH2024',
      clicks: 892,
      conversions: 67,
    },
    {
      id: '2',
      name: 'Instagram Bio',
      url: 'https://eonpro.com/r/SARAH2024-ig',
      clicks: 234,
      conversions: 15,
    },
    {
      id: '3',
      name: 'Email Campaign',
      url: 'https://eonpro.com/r/SARAH2024-email',
      clicks: 121,
      conversions: 7,
    },
  ],
...
const HomeIcon = ({ active }: { active: boolean }) => (
  <svg
    className={`h-6 w-6 ${active ? 'text-gray-900' : 'text-gray-400'}`}
    fill="none"
    stroke="currentColor"
    viewBox="0 0 24 24"
  >
...
export default function AffiliateDemo() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      {/* Mobile Bottom Nav */}
      <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-gray-100 bg-white px-2">
        <div className="flex h-16 items-center justify-around">
          {tabs.map((tab) => (
            ...
            >
              ...
              <span
                className={`mt-1 text-xs ${activeTab === tab.id ? 'font-medium text-gray-900' : 'text-gray-400'}`}
              >
                {tab.label}
              </span>
              {activeTab === tab.id && (
                <div className="absolute top-0 h-0.5 w-8 rounded-full bg-gray-900" />
              )}
            </button>
          ))}
        </div>
    ...
    >
      ...
      <header className="border-b border-gray-100 bg-white px-6 py-6">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="text-2xl font-semibold text-gray-900">{mockData.affiliate.displayName}</h1>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-3xl space-y-6 px-6 py-6">
        ...
        <div className="rounded-2xl bg-gray-900 p-6 text-white">
          ...
          <div className="flex items-center gap-4">
            <button className="flex-1 rounded-xl bg-white py-3 text-center font-medium text-gray-900 transition-colors hover:bg-gray-100">
              Withdraw
            </button>
            <button className="flex-1 rounded-xl bg-white/10 py-3 text-center font-medium transition-colors hover:bg-white/20">
              View Details
            </button>
          </div>
            ...
            {mockData.recentActivity.map((activity, index) => (
              <div key={activity.id} className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div
                    className={`flex h-8 w-8 items-center justify-center rounded-full ${activity.type === 'conversion' ? 'bg-green-50' : 'bg-[#fdf6e3]'}`}
                  >
    ...
    >
      <header className="border-b border-gray-100 bg-white px-6 py-6">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-1 text-sm text-gray-500">Track your commissions and payouts</p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-3xl space-y-6 px-6 py-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="rounded-2xl bg-white p-5">
            ...
            <button className="mt-3 w-full rounded-lg bg-gray-900 py-2 text-sm font-medium text-white">
              Withdraw
            </button>
          </div>
          <div className="rounded-2xl bg-white p-5">
            ...
            {mockData.earningsHistory.map((item) => (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <p
                    className={`text-xs ${item.status === 'Paid' ? 'text-gray-400' : 'text-amber-500'}`}
                  >
                    {item.status}
                  </p>
                </div>
        ...
        {/* Payout Settings */}
        <div className="rounded-2xl bg-white p-6">
          <h2 className="mb-4 font-semibold text-gray-900">Payout Method</h2>
          <div className="flex items-center justify-between rounded-xl bg-gray-50 p-4">
            ...
            <button className="text-sm font-medium text-[#b5a05a]">Change</button>
          </div>
        </div>
      </div>
    </motion.div>
    ...
    >
      <header className="border-b border-gray-100 bg-white px-6 py-6">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-1 text-sm text-gray-500">Manage and track your referral links</p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-3xl space-y-6 px-6 py-6">
        {/* Main Referral Code */}
        <div className="rounded-2xl bg-gray-900 p-6 text-white">
          <p className="mb-2 text-sm text-gray-400">Your Referral Code</p>
        ...
        <div className="space-y-4">
          {mockData.links.map((link) => (
            <div key={link.id} className="rounded-2xl bg-white p-5">
              <div className="mb-3 flex items-start justify-between">
                <div>
                  <p className="font-semibold text-gray-900">{link.name}</p>
                  <p className="max-w-[200px] truncate text-sm text-gray-400">{link.url}</p>
                </div>
                <button
        ...
        {/* Create New Link */}
        <button className="w-full rounded-2xl border-2 border-dashed border-gray-200 py-4 font-medium text-gray-500 transition-colors hover:border-gray-300 hover:text-gray-600">
          + Create New Link
        </button>
      </div>
    </motion.div>
    ...
    >
      <header className="border-b border-gray-100 bg-white px-6 py-6">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-1 text-sm text-gray-500">Manage your profile and settings</p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-3xl space-y-6 px-6 py-6">
        ...
        <div className="rounded-2xl bg-white p-6">
          <div className="mb-6 flex items-center gap-4">
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-[#cab172] to-[#a89048] text-2xl font-bold text-white">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between border-b border-gray-100 py-3">
              ...
              <span className="font-mono text-gray-900">{mockData.affiliate.referralCode}</span>
            </div>
        ...
        {/* Settings Menu */}
        <div className="divide-y divide-gray-100 rounded-2xl bg-white">
        ...
        {/* Sign Out */}
        <button className="w-full rounded-2xl bg-red-50 py-4 font-medium text-red-600 transition-colors hover:bg-red-100">
          Sign Out
        </button>
