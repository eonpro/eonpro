  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="mx-auto max-w-3xl px-6 py-8">
        ...
        >
          <h2 className="mb-6 text-2xl font-semibold text-gray-900">Affiliate Partner Agreement</h2>

          <div className="prose prose-gray max-w-none">
            <p className="mb-6 text-gray-600">Last updated: January 2026</p>

            <h3 className="mb-4 mt-8 text-lg font-semibold text-gray-900">1. Program Overview</h3>
            <p className="mb-4 text-gray-600">
              This Affiliate Partner Agreement (&quot;Agreement&quot;) governs your participation in
              our affiliate program. By joining the program, you agree to these terms.
            </p>
            ...
            <p className="mb-4 text-gray-600">
              You will earn commissions on qualifying sales made through your unique referral links.
              Commission rates are displayed in your dashboard and may vary based on your tier
              level.
            </p>
            <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600">
              <li>
                Commissions are calculated on the net sale amount (excluding taxes and shipping)
              </li>
            ...
            <h3 className="mb-4 mt-8 text-lg font-semibold text-gray-900">3. Payment Terms</h3>
            <p className="mb-4 text-gray-600">
              Payouts are processed on a monthly basis for affiliates who have reached the minimum
            ...
            <h3 className="mb-4 mt-8 text-lg font-semibold text-gray-900">4. Cookie Duration</h3>
            <p className="mb-4 text-gray-600">
              We use a 30-day cookie window for attribution. If a referred customer makes a purchase
              within 30 days of clicking your link, you will receive credit for the sale.
            </p>
            ...
            <h3 className="mb-4 mt-8 text-lg font-semibold text-gray-900">6. Compliance</h3>
            <p className="mb-4 text-gray-600">
            ...
            <h3 className="mb-4 mt-8 text-lg font-semibold text-gray-900">7. Termination</h3>
            <p className="mb-4 text-gray-600">
            ...
            <h3 className="mb-4 mt-8 text-lg font-semibold text-gray-900">8. Modifications</h3>
            <p className="mb-4 text-gray-600">
              We reserve the right to modify these terms at any time. Material changes will be
              communicated via email with at least 30 days notice.
            </p>

            <h3 className="mb-4 mt-8 text-lg font-semibold text-gray-900">9. Contact</h3>
            <p className="mb-4 text-gray-600">
              For questions about this agreement or the affiliate program, please contact us at{' '}
