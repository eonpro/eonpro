...
import { BRAND as BRAND_ASSETS } from '@/lib/constants/brand-assets';
...
const TREATMENTS = [
  {
    ...
    label: 'Better',
    keyword: 'Sex',
    image: BRAND_ASSETS.brand.categorySex,
    keywordColor: '#771911',
    hoverBg: '#ea3942',
    hoverBgDark: '#c52a32',
  ...
  },
  {
    ...
    label: 'Peptide',
    keyword: 'Therapies',
    image: BRAND_ASSETS.brand.categoryPeptides,
    keywordColor: '#b76e32',
    hoverBg: '#f1994e',
    hoverBgDark: '#d47830',
  ...
  },
  {
    ...
    label: 'Stay',
    keyword: 'Young',
    image: BRAND_ASSETS.brand.categoryYoung,
    keywordColor: '#3e83f7',
    hoverBg: '#204ac5',
    hoverBgDark: '#152d8a',
  ...
  },
  {
    ...
    image: BRAND_ASSETS.brand.categoryTestosterone,
    keywordColor: '#295f3d',
    hoverBg: '#59c27b',
    hoverBgDark: '#3a9957',
  ...
  },
  {
    ...
    label: 'Lose',
    keyword: 'Weight',
    image: BRAND_ASSETS.brand.categoryWeight,
    keywordColor: '#b39231',
    hoverBg: '#f7cc49',
    hoverBgDark: '#d4a825',
...
// ============================================================================
// Brand Assets — from centralized brand-assets
// ============================================================================

const ASSETS = {
  logo: BRAND_ASSETS.logos.affiliateLogo,
  googleStars: BRAND_ASSETS.brand.googleStars,
  press: {
    foxNews: BRAND_ASSETS.press.foxNews,
    mensHealth: BRAND_ASSETS.press.mensHealth,
    gq: BRAND_ASSETS.press.gq,
    businessInsider: BRAND_ASSETS.press.businessInsider,
    miamiHerald: BRAND_ASSETS.press.miamiHerald,
...
function ArrowRight({ color = PALETTE.textMuted }: { color?: string }) {
  return (
    <svg
      className="h-5 w-5"
      fill="none"
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div
        ...
        style={{ background: `linear-gradient(to right, ${PALETTE.white}, transparent)` }}
      />
      <div
        className="pointer-events-none absolute inset-y-0 right-0 z-10 w-16"
        style={{ background: `linear-gradient(to left, ${PALETTE.white}, transparent)` }}
      />
...
function AffiliateLandingContent() {
  ...
  return (
    <div className="min-h-screen font-sofia" style={{ backgroundColor: PALETTE.cream, color: PALETTE.text }}>
      ...
      {/* ================================================================ */}
      <section style={{ backgroundColor: PALETTE.white }}>
            ...
            {STEPS.map((step) => (
              ...
              >
                <div
                  ...
                  style={{ backgroundColor: PALETTE.tagBg, color: PALETTE.accent }}
                >
                  {step.number}
                </div>
      ...
      <section>
        <div className="mx-auto max-w-5xl px-6 py-16 md:py-24">
          <div className="mb-12 text-center">
            <p className="mb-3 text-sm font-semibold" style={{ color: PALETTE.accent }}>
              96% of members love their results
            </p>
            <h2 className="mb-3 text-3xl font-bold tracking-tight md:text-4xl">
              Trusted by <span style={{ color: PALETTE.accent }}>thousands</span>
            </h2>
          </div>
          ...
          <div className="grid items-center gap-12 md:grid-cols-2">
            ...
            <div className="flex justify-center">
              <div className="w-full max-w-xs rounded-2xl p-10 text-center" style={{ backgroundColor: PALETTE.white }}>
                ...
                <div className="my-6" style={{ borderTop: `1px solid ${PALETTE.border}` }} />
            ...
            <div className="flex items-center gap-4">
              ...
              {isValid && (
                <span
                  ...
                  style={{ backgroundColor: PALETTE.tagBg, color: PALETTE.textMuted }}
                >
                  Partner: {refCode}
                </span>
              )}
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        >
          <ArrowRight color={hovered ? '#FFFFFF' : PALETTE.textMuted} />
        </div>
      </div>
    </a>
  );
