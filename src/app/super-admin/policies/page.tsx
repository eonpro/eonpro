              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-amber-700 mt-2">
                    The policy management tables have not been created in the production database yet.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                <div className="bg-gray-900 rounded-lg p-4 font-mono text-sm text-green-400 overflow-x-auto">
                  <div className="text-gray-500"># Run these commands on the production server:</div>
                  <div className="mt-2">npx prisma db push</div>
                  <div className="mt-1">npx tsx scripts/seed-policies.ts</div>
                </div>
                <div className="text-sm text-gray-600">
                  <p className="mb-2"><strong>Step 1:</strong> <code className="bg-gray-100 px-2 py-1 rounded">prisma db push</code> creates the Policy, PolicyApproval, and PolicyAcknowledgment tables.</p>
                  <p><strong>Step 2:</strong> <code className="bg-gray-100 px-2 py-1 rounded">seed-policies.ts</code> loads the 8 SOC 2 policies into the database.</p>
                </div>
              </div>
              <button 
