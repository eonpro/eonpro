      ...
      <div className="mb-6 rounded-xl border border-gray-100 bg-white p-4 shadow-sm">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <select value={preset} onChange={(e) => setPreset(e.target.value)} className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm focus:border-[var(--brand-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--brand-primary)]/20">
