...
interface ClinicFeatures {
  ...
  pharmacy: boolean;
  ai: boolean;
  /** Show Labs / bloodwork tab on patient profile (e.g. for ot.eonpro.io) */
...
function PatientPortalPresetBlock({ clinicId }: { clinicId: number }) {
  ...
  const handleApplyPreset = async () => {
    ...
    try {
      ...
      if (putRes.ok)
        alert('Patient portal preset applied. Patients will see the updated features.');
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-6">
      ...
      <p className="mb-4 text-sm text-gray-500">
        Apply a treatment-based preset to set which tabs and tools patients see. For full control,
        use Admin portal settings.
      </p>
...
export default function ClinicDetailPage() {
  ...
  const [lifefileMessage, setLifefileMessage] = useState<{
    type: 'success' | 'error';
    text: string;
  } | null>(null);
      ...
      if (response.ok) {
        ...
        const fetchedClinic: Clinic = {
          ...
          features: {
            ...
            BLOODWORK_LABS: clinicData.features?.BLOODWORK_LABS !== false,
          },
          stats: {
      ...
      if (response.ok) {
        ...
        if (s) {
          ...
          const newState = {
            ...
            lifefileInboundEvents: Array.isArray(s.lifefileInboundEvents)
              ? s.lifefileInboundEvents
              : [],
  ...
  const handleTestLifefile = async () => {
    ...
    try {
      ...
      if (data.success) {
        setLifefileMessage({
          type: 'success',
          text: 'Connection test successful! Lifefile is configured correctly.',
        });
      } else {
        setLifefileMessage({
          type: 'error',
          text: data.detail || data.error || 'Connection test failed',
        });
      }
    } catch (error) {
  ...
  const handleTestInbound = async () => {
    ...
    try {
      ...
      if (data.success) {
        setInboundMessage({
          type: 'success',
          text: data.message || 'Inbound webhook test successful!',
        });
      } else {
    ...
    <div className="min-h-screen bg-[#efece7]">
      <div className="border-b border-gray-200 bg-transparent">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  ...
                  {clinic.customDomain && <span className="ml-2">• {clinic.customDomain}</span>}
                </p>
              </div>
            </div>
            <div className="flex items-center gap-3">
          ...
          <div className="-mb-px mt-6 flex gap-6 overflow-x-auto border-b border-gray-200">
            {[
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-gray-900">
                      {clinic.stats.patients.toLocaleString()}
                    </p>
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-gray-900">
                      {clinic.stats.appointments.toLocaleString()}
                    </p>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                  ...
                  <div className="flex">
                    <input
                      ...
                      className="flex-1 rounded-l-lg border border-gray-300 px-4 py-2 focus:border-teal-500 focus:ring-2 focus:ring-teal-500"
                    />
                ...
                <div>
                  <label
                    htmlFor="branding-custom-domain"
                    className="mb-1 block text-sm font-medium text-gray-700"
                  >
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData({ ...formData, primaryColor: e.target.value })}
                      placeholder="#10B981"
                      className="flex-1 rounded-lg border border-gray-300 px-4 py-2 font-mono text-sm focus:border-teal-500 focus:ring-2 focus:ring-teal-500"
        ...
        {activeTab === 'features' && (
          <div className="space-y-6">
            <div className="rounded-xl border border-gray-200 bg-white p-6">
              <h3 className="mb-4 text-lg font-semibold text-gray-900">Enabled Features</h3>
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    description: 'HIPAA-compliant patient messaging',
                  },
                  {
                    key: 'billing',
                  ...
                  },
                  {
                    ...
                    description: 'E-prescriptions and pharmacy network',
                  },
                  {
                    key: 'ai',
                    label: 'AI Assistant (Becca)',
                    description: 'AI-powered clinical assistance',
                  },
                ].map((feature) => (
                  <div
                    key={feature.key}
          ...
          <div className="space-y-6">
            ...
            {loadingLifefile ? (
              ...
              <>
                    ...
                    <label className="relative inline-flex cursor-pointer items-center">
                      <input
                        ...
                        onChange={(e) =>
                          setLifefileSettings({
                            ...lifefileSettings,
                            lifefileEnabled: e.target.checked,
                          })
                        }
                        className="peer sr-only"
                      />
                    ...
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setLifefileSettings({
                            ...lifefileSettings,
                            lifefileBaseUrl: e.target.value,
                          })
                        }
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setLifefileSettings({
                            ...lifefileSettings,
                            lifefileUsername: e.target.value,
                          })
                        }
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setLifefileSettings({
                            ...lifefileSettings,
                            lifefilePassword: e.target.value,
                          })
                        }
                        placeholder="••••••••"
                        className="w-full rounded-lg border border-gray-300 px-4 py-3 focus:border-teal-500 focus:ring-2 focus:ring-teal-500"
                ...
                <div className="rounded-xl border border-gray-200 bg-white p-6">
                  ...
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setLifefileSettings({
                            ...lifefileSettings,
                            lifefileVendorId: e.target.value,
                          })
                        }
                        placeholder="11596"
                        className="w-full rounded-lg border border-gray-300 px-4 py-3 focus:border-teal-500 focus:ring-2 focus:ring-teal-500"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setLifefileSettings({
                            ...lifefileSettings,
                            lifefilePracticeId: e.target.value,
                          })
                        }
                        placeholder="1270268"
                        className="w-full rounded-lg border border-gray-300 px-4 py-3 focus:border-teal-500 focus:ring-2 focus:ring-teal-500"
                    ...
                    <div>
                      <label className="mb-1 block text-sm font-medium text-gray-700">
                        Location ID *{' '}
                        <span className="text-gray-400">(Logos Pharmacy = 110396)</span>
                      </label>
                      <input
                        type="text"
                        ...
                        onChange={(e) =>
                          setLifefileSettings({
                            ...lifefileSettings,
                            lifefileLocationId: e.target.value,
                          })
                        }
                        placeholder="110396"
                        className="w-full rounded-lg border border-gray-300 px-4 py-3 focus:border-teal-500 focus:ring-2 focus:ring-teal-500"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setLifefileSettings({
                            ...lifefileSettings,
                            lifefileNetworkId: e.target.value,
                          })
                        }
                        placeholder="1592"
                        className="w-full rounded-lg border border-gray-300 px-4 py-3 focus:border-teal-500 focus:ring-2 focus:ring-teal-500"
                    ...
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setLifefileSettings({
                            ...lifefileSettings,
                            lifefilePracticeName: e.target.value,
                          })
                        }
                    ...
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setLifefileSettings({
                            ...lifefileSettings,
                            lifefilePracticeAddress: e.target.value,
                          })
                        }
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setLifefileSettings({
                            ...lifefileSettings,
                            lifefilePracticePhone: e.target.value,
                          })
                        }
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setLifefileSettings({
                            ...lifefileSettings,
                            lifefilePracticeFax: e.target.value,
                          })
                        }
                ...
                {/* Features Info */}
                <div className="rounded-xl border border-teal-200 bg-gradient-to-br from-teal-50 to-blue-50 p-6">
                  <h3 className="mb-4 flex items-center gap-2 text-lg font-semibold text-gray-900">
                    <Zap className="h-5 w-5 text-teal-600" />
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    {[
                      {
                        icon: FileText,
                        label: 'PDF64 e-Script Generation',
                        desc: 'Automatic prescription PDF creation',
                      },
                      {
                        icon: Shield,
                        label: 'Doctor Signature Attachment',
                        desc: 'Digital signatures on prescriptions',
                      },
                      {
                        icon: Pill,
                        label: 'Direct Pharmacy Submission',
                        desc: 'Send directly to Logos Pharmacy',
                      },
                      {
                        icon: Activity,
                        label: 'Real-time Status Updates',
                        desc: 'Track prescription fulfillment',
                      },
                    ].map((feature, idx) => (
                  ...
                  <div className="mb-6 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          Configure this clinic to receive data FROM Lifefile (shipping updates,
                          prescription status, etc.)
                        </p>
                      </div>
                    </div>
                    <label className="relative inline-flex cursor-pointer items-center">
                      <input
                        ...
                        onChange={(e) =>
                          setLifefileSettings({
                            ...lifefileSettings,
                            lifefileInboundEnabled: e.target.checked,
                          })
                        }
                        className="peer sr-only"
                      />
                    ...
                    <div className="mb-6 rounded-lg bg-blue-50 p-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="flex items-center gap-1 whitespace-nowrap rounded-lg bg-blue-600 px-3 py-2 text-sm text-white hover:bg-blue-700"
                        >
                          {copiedInboundUrl ? (
                  ...
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div className="md:col-span-2">
                      ...
                      <div className="flex items-center">
                        <span className="mr-2 whitespace-nowrap text-sm text-gray-500">
                          /api/webhooks/lifefile/inbound/
                        </span>
                        <input
                          type="text"
                          ...
                          onChange={(e) =>
                            setLifefileSettings({
                              ...lifefileSettings,
                              lifefileInboundPath: e.target.value
                                .toLowerCase()
                                .replace(/[^a-z0-9_-]/g, ''),
                            })
                          }
                      ...
                      <p className="mt-1 text-xs text-gray-500">
                        Unique identifier for this clinic&apos;s webhook endpoint (letters, numbers,
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          onChange={(e) =>
                            setLifefileSettings({
                              ...lifefileSettings,
                              lifefileInboundUsername: e.target.value,
                            })
                          }
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            setLifefileSettings({
                              ...lifefileSettings,
                              lifefileInboundUsername: username,
                            });
                          }}
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          onChange={(e) =>
                            setLifefileSettings({
                              ...lifefileSettings,
                              lifefileInboundPassword: e.target.value,
                            })
                          }
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            setLifefileSettings({
                              ...lifefileSettings,
                              lifefileInboundPassword: password,
                            });
                          }}
                          className="whitespace-nowrap rounded-lg border border-gray-300 px-3 py-2 text-sm hover:bg-gray-50"
                        >
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          onChange={(e) =>
                            setLifefileSettings({
                              ...lifefileSettings,
                              lifefileInboundSecret: e.target.value,
                            })
                          }
                      ...
                      <p className="mt-1 text-xs text-gray-500">
                        For additional signature verification
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setLifefileSettings({
                            ...lifefileSettings,
                            lifefileInboundAllowedIPs: e.target.value,
                          })
                        }
                    ...
                    <div className="md:col-span-2">
                      ...
                      <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
                        {[
                          ...
                          const isChecked = lifefileSettings.lifefileInboundEvents.includes(
                            event.value
                          );
                          ...
                          return (
                            <button
                              ...
                              onClick={() => {
                                const events = isChecked
                                  ? lifefileSettings.lifefileInboundEvents.filter(
                                      (e) => e !== event.value
                                    )
                                  : [...lifefileSettings.lifefileInboundEvents, event.value];
                                setLifefileSettings({
                                  ...lifefileSettings,
                                  lifefileInboundEvents: events,
                                });
                              }}
                            ...
                            >
                              ...
                              {isChecked && (
                                <div className="absolute -right-2 -top-2 flex h-7 w-7 items-center justify-center rounded-full bg-green-500 shadow-lg">
                                  <Check className="h-5 w-5 text-white" strokeWidth={3} />
                                </div>
                              )}
                              <IconComponent
                                className={`mb-2 h-8 w-8 ${isChecked ? 'text-green-600' : 'text-gray-500'}`}
                              />
                              <span
                                className={`text-center text-sm font-medium ${isChecked ? 'text-green-700' : 'text-gray-700'}`}
                              >
                                {event.label}
                              </span>
                            </button>
                      ...
                      <p className="mt-2 text-xs text-gray-500">
                        Click to select multiple event types
                      </p>
                    </div>
                  </div>

                  {/* Sample cURL */}
                  {lifefileSettings.lifefileInboundPath &&
                    lifefileSettings.lifefileInboundUsername && (
                      <div className="mt-6 rounded-lg bg-gray-900 p-4">
                        <div className="mb-2 flex items-center justify-between">
                          <span className="text-sm text-gray-400">
                            Sample cURL command for Lifefile:
                          </span>
                        </div>
                        <code className="whitespace-pre-wrap break-all font-mono text-xs text-green-400">
  ...
  -d '{"type": "shipping", "trackingNumber": "1Z999AA10123456784", "orderId": "12345"}'`}
                  ...
                  {inboundMessage && (
                    <div
                      className={`mt-4 rounded-lg p-4 ${inboundMessage.type === 'success' ? 'border border-green-200 bg-green-50 text-green-800' : 'border border-red-200 bg-red-50 text-red-800'}`}
                    >
                      <div className="flex items-center gap-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-gray-200 bg-white p-6">
                  ...
                  <div className="flex items-center gap-4">
                    <button
                      ...
                      disabled={
                        testingLifefile ||
                        !lifefileSettings.lifefileBaseUrl ||
                        !lifefileSettings.lifefileUsername
                      }
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 rounded-lg bg-teal-600 px-8 py-3 text-white transition-colors hover:bg-teal-700 disabled:opacity-50"
                    >
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6">
              <div className="mb-6 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Manage administrators, providers, and staff for this clinic
                  </p>
                </div>
                <button
              ...
              {loadingUsers ? (
                ...
                <div className="rounded-lg bg-gray-50 py-12 text-center">
                  ...
                  <p className="mb-4 text-gray-500">Add the first administrator to get started</p>
                  <button
                    onClick={() => setShowAddUserModal(true)}
        ...
        {activeTab === 'settings' && (
          <div className="space-y-6">
            <div className="rounded-xl border border-gray-200 bg-white p-6">
              <h3 className="mb-4 text-lg font-semibold text-gray-900">Clinic Status</h3>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6">
              ...
              {loadingInviteCodes ? (
                ...
                <div className="rounded-lg border-2 border-dashed border-gray-200 bg-gray-50 py-8 text-center">
                  ...
                  <h4 className="mb-1 font-medium text-gray-900">No invite codes yet</h4>
                  <p className="mb-4 text-sm text-gray-500">
                    Create a code so patients can register for this clinic
                  </p>
                  <button
                    onClick={() => setShowAddInviteCodeModal(true)}
                    className="inline-flex items-center gap-2 rounded-lg bg-teal-600 px-4 py-2 text-white transition-colors hover:bg-teal-700"
                  ...
                  {inviteCodes.map((code) => (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2">
                          <span
                            className={`font-mono text-lg font-bold ${code.isActive ? 'text-gray-900' : 'text-gray-400'}`}
                          >
                            {code.code}
                          </span>
                          <button
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6">
              <h3 className="mb-4 text-lg font-semibold text-gray-900">Danger Zone</h3>
      ...
      {showAddUserModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-black/50 py-8">
          <div className="mx-4 my-auto w-full max-w-lg rounded-xl bg-white shadow-xl">
            ...
            <form onSubmit={handleAddUser} className="max-h-[70vh] space-y-4 overflow-y-auto p-6">
                ...
                <div className="space-y-4 rounded-lg border border-blue-200 bg-blue-50 p-4">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 rounded-lg border border-gray-300 px-4 py-2 focus:border-teal-500 focus:ring-2 focus:ring-teal-500"
                      ...
                      <button
                        ...
                        className="whitespace-nowrap rounded-lg bg-blue-600 px-4 py-2 text-sm text-white transition-colors hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-50"
                      >
                        {lookingUpNpi ? 'Looking up...' : 'Lookup NPI'}
                      </button>
                    </div>
                    {npiError && <p className="mt-1 text-xs text-red-600">{npiError}</p>}
                    <p className="mt-1 text-xs text-gray-500">
                      Enter NPI and click lookup to auto-fill provider info
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setNewUser({ ...newUser, deaNumber: e.target.value.toUpperCase() })
                      }
                      className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-teal-500 focus:ring-2 focus:ring-teal-500"
              ...
              <div className="flex gap-3 border-t border-gray-200 pt-4">
                ...
                <button
                  type="submit"
                  disabled={addingUser}
                  className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-teal-600 px-4 py-2 text-white transition-colors hover:bg-teal-700 disabled:opacity-50"
                >
                  {addingUser ? (
                    <>
          ...
          <div className="mx-4 w-full max-w-md rounded-xl bg-white shadow-xl">
            ...
            <div className="space-y-4 p-6">
              <p className="text-sm text-gray-600">
                ...
                <span className="font-medium">{resetPasswordModal.userName}</span>
              </p>
      ...
      {showAddInviteCodeModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="mx-4 w-full max-w-md rounded-xl bg-white shadow-xl">
            ...
            <form onSubmit={handleAddInviteCode} className="space-y-4 p-6">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-gray-300 px-4 py-2 font-mono uppercase focus:border-teal-500 focus:ring-2 focus:ring-teal-500"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewInviteCode({ ...newInviteCode, description: e.target.value })
                  }
                  className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-teal-500 focus:ring-2 focus:ring-teal-500"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewInviteCode({ ...newInviteCode, usageLimit: e.target.value })
                  }
                  className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-teal-500 focus:ring-2 focus:ring-teal-500"
      ...
      {editUserModal.show && editUserModal.user && (
        <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-black/50 py-8">
          <div className="mx-4 my-auto w-full max-w-lg rounded-xl bg-white shadow-xl">
            ...
            <form onSubmit={handleEditUser} className="max-h-[70vh] space-y-4 overflow-y-auto p-6">
              {/* Role Selection */}
              <div>
                <label className="mb-1 block text-sm font-medium text-gray-700">Role</label>
                <select
                ...
                <div className="space-y-4 rounded-lg border border-blue-200 bg-blue-50 p-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setEditUserData({ ...editUserData, licenseNumber: e.target.value })
                        }
                        className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-teal-500 focus:ring-2 focus:ring-teal-500"
                        placeholder="License #"
                      />
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setEditUserData({ ...editUserData, licenseState: e.target.value })
                        }
                        className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-teal-500 focus:ring-2 focus:ring-teal-500"
                      >
                        <option value="">Select State</option>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEditUserData({ ...editUserData, specialty: e.target.value })
                      }
                      className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-teal-500 focus:ring-2 focus:ring-teal-500"
