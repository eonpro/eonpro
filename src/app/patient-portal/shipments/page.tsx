...
export default function ShipmentsPage() {
  ...
  const {
    ...
    isValidating,
    mutate,
  } = usePortalSWR<TrackingResponse>('/api/patient-portal/tracking');
      ...
      {allShipments.length === 0 && (!prescriptionJourney || prescriptionJourney.stage > 3) ? (
        <div className="rounded-2xl border border-gray-100 bg-white p-12 text-center shadow-sm">
          ...
          <p className="text-gray-500">
            Your shipments will appear here once your prescriptions are shipped.
          </p>
        </div>
      ) : (
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      >
                        <Truck
                          className="h-5 w-5"
                          style={{ color: isException ? '#DC2626' : primaryColor }}
                        />
                      </div>
                      <div>
                          ...
                          <div key={step.key} className="flex flex-1 items-center">
                            <div className="flex flex-col items-center">
                              <div
                                ...
                                style={{
                                  ...(isCompleted || isCurrent
                                    ...
                                    : {}),
                                  ...(isCurrent ? { ringColor: `${primaryColor}30` } : {}),
                                }}
                              >
                              ...
                              <span
                                ...
                                style={
                                  isCompleted || isCurrent ? { color: primaryColor } : undefined
                                }
                              >
                                {step.label}
                              </span>
                  ...
                  {shipment.patientConfirmedAt ? (
                    ...
                    >
                      {confirmingTrackingNumber === shipment.trackingNumber ? (
                        ...
                        <>
                          <PackageCheck className="h-5 w-5" />I Received My Package
                        </>
                      )}
                    </button>
                  ) : null}
