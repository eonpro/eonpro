...
const dosingSchedule = [
  ...
  { week: '13-16', dose: 10, label: 'Weeks 13-16', desc: 'Approaching target' },
  { week: '17-20', dose: 12.5, label: 'Weeks 17-20', desc: 'Second target' },
  { week: '21+', dose: 15, label: 'Week 21+', desc: 'Maintenance dose' },
];
...
export default function TirzepatideDoseCalculatorPage() {
  ...
  const result = useMemo(() => {
    ...
    return { mg: mg.toFixed(1), mL: mL.toFixed(3) };
  }, [units, concentration]);
    ...
    <div className="min-h-[100dvh] px-4 py-6">
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-500">
          Convert units to milligrams for your Tirzepatide injection
        </p>
      </div>
