...
export default function IntegrationsPage() {
  const [integrations, setIntegrations] = useState<Integration[]>([
    {
      ...
      status: 'connected',
      configFields: [
        { key: 'base_url', label: 'API Base URL', type: 'text', value: 'https://portal.lifefilehealth.com' },
  ...
  const handleSave = async (integrationId: string) => {
    ...
    setIntegrations(integrations.map((int: any) => 
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Connect and configure external services</p>
      </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      <span className={`px-2 py-1 text-xs font-semibold rounded-full inline-flex items-center ${getStatusColor(integration.status)}`}>
