  ...
  return (
    ...
    >
      ...
      <div className="p-5 sm:p-6">
        {/* Product image */}
        <div className="mb-2 flex items-center justify-center rounded-xl py-3" style={{ backgroundColor: '#f8f9fa' }}>
          <Image
            src={imageSrc}
        ...
        <div className="mb-4 flex items-center justify-center gap-5 text-xs font-medium tracking-wider text-gray-400">
          ...
          <span className="font-bold" style={{ letterSpacing: '0.05em' }}>USA TODAY</span>
        </div>

        {/* Title + rating */}
        <h3 className="mb-1.5 text-base font-bold leading-snug sm:text-lg" style={{ color: '#101010' }}>
          {displayName}
        </h3>
        ...
        <div className="mb-5 flex w-fit items-center gap-2 rounded-lg border border-green-200 bg-green-50 px-3 py-2">
          ...
          <span className="text-sm font-semibold text-green-700">Recommended for most patients</span>
        </div>
        ...
        <div className="mb-1">
          <p className="text-sm font-bold tracking-wide" style={{ color: '#101010' }}>MONTHLY PLAN</p>
          <p className="text-xs font-medium italic text-green-600">Lowest industry pricing</p>
        </div>

        <div className="mb-2 flex items-baseline gap-1">
          <span className="text-3xl font-bold" style={{ color: '#22c55e' }}>${monthlyPrice}</span>
