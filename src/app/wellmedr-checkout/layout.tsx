...
export default function WellMedrCheckoutLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      {gadsConversionId && (
        <>
          <Script
            src={`https://www.googletagmanager.com/gtag/js?id=AW-${gadsConversionId}`}
            strategy="afterInteractive"
          />
          <Script id="wellmedr-google-ads-gtag" strategy="afterInteractive">
...
gtag('config', 'AW-${gadsConversionId}');`}
      ...
      {gtmId && (
        <>
          <Script id="wellmedr-gtm-script" strategy="afterInteractive">
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
      ...
      {posthogKey && (
        <Script id="wellmedr-posthog-script" strategy="afterInteractive">
...
posthog.init('${posthogKey}',{api_host:'${posthogHost}',person_profiles:'always'});`}
        </Script>
      )}
