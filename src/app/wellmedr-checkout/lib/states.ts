...
// State abbreviations as const tuple for Zod validation
...
// Full state name type
export type StateName = keyof typeof STATE_NAME_TO_ABBREVIATION;
...
export function stateNameToAbbreviation(stateName: string): StateAbbreviation | string {
  ...
  if (abbreviations.includes(stateName as StateAbbreviation)) {
    return stateName as StateAbbreviation;
  }

  // Otherwise try to convert from full name
