...
const steps: FormStep[] = [
  // ===== INTRO / LANDING =====
  {
    ...
    path: 'trt-intro',
    title: {
      en: 'Reclaim your energy, drive, and confidence.',
      es: 'Recupera tu energía, impulso y confianza.',
    },
    subtitle: {
      en: 'Clinically guided Testosterone Replacement Therapy.',
      es: 'Terapia de Reemplazo de Testosterona clínicamente guiada.',
    },
    type: 'custom',
        ...
        options: [
          {
            ...
            label: { en: 'Fatigue or low energy', es: 'Fatiga o baja energía' },
            value: 'fatigue_low_energy',
          },
          {
            id: 'low_libido',
            label: {
              en: 'Low libido or decreased sex drive',
              es: 'Libido bajo o disminución del deseo sexual',
            },
            value: 'low_libido',
          },
          {
            id: 'erectile_dysfunction',
            label: { en: 'Erectile dysfunction', es: 'Disfunción eréctil' },
            value: 'erectile_dysfunction',
          },
          {
            id: 'mood_changes',
            label: {
              en: 'Mood changes, irritability, or depression',
              es: 'Cambios de humor, irritabilidad o depresión',
            },
            value: 'mood_changes',
          },
          {
            id: 'muscle_loss',
            label: {
              en: 'Loss of muscle mass or strength',
              es: 'Pérdida de masa muscular o fuerza',
            },
            value: 'muscle_loss',
          },
          {
            id: 'body_fat',
            label: {
              en: 'Increased body fat or belly fat',
              es: 'Aumento de grasa corporal o abdominal',
            },
            value: 'body_fat',
          },
          {
            id: 'brain_fog',
            label: {
              en: 'Brain fog or poor concentration',
              es: 'Niebla mental o poca concentración',
            },
            value: 'brain_fog',
          },
          {
            id: 'sleep_problems',
            label: { en: 'Sleep problems or insomnia', es: 'Problemas de sueño o insomnio' },
            value: 'sleep_problems',
          },
          {
            id: 'hair_thinning',
            label: { en: 'Hair thinning or loss', es: 'Adelgazamiento o pérdida de cabello' },
            value: 'hair_thinning',
          },
          {
            id: 'hot_flashes',
            label: { en: 'Hot flashes or night sweats', es: 'Sofocos o sudores nocturnos' },
            value: 'hot_flashes',
          },
        ],
        validation: [
  ...
  // ===== TRT INTEREST =====
  {
    ...
    path: 'trt-interest',
    title: {
      en: 'What brings you to Testosterone Replacement Therapy?',
      es: '¿Qué te trae a la Terapia de Reemplazo de Testosterona?',
    },
    type: 'single-select',
    fields: [
      {
        ...
        options: [
          {
            id: 'low_energy',
            label: {
              en: 'I have low energy and want to feel like myself again',
              es: 'Tengo poca energía y quiero sentirme como antes',
            },
            value: 'low_energy',
          },
          {
            id: 'low_libido',
            label: {
              en: "I'm experiencing low libido or sexual health concerns",
              es: 'Estoy experimentando libido bajo o preocupaciones de salud sexual',
            },
            value: 'low_libido',
          },
          {
            ...
            label: {
              en: 'My doctor recommended I explore TRT',
              es: 'Mi médico me recomendó explorar TRT',
            },
            value: 'doctor_recommended',
          },
          {
            id: 'switching_providers',
            label: {
              en: "I'm currently on TRT and looking for a new provider",
              es: 'Actualmente estoy en TRT y busco un nuevo proveedor',
            },
          ...
          },
          {
            id: 'optimize_health',
            label: {
              en: 'I want to optimize my overall health and vitality',
              es: 'Quiero optimizar mi salud general y vitalidad',
            },
            value: 'optimize_health',
          },
        ],
      },
    ],
    ...
    fields: [
      {
        ...
        options: [
          {
            id: 'energy_stamina',
            label: { en: 'Increased energy and stamina', es: 'Mayor energía y resistencia' },
            value: 'energy_stamina',
          },
          {
            id: 'libido_performance',
            label: {
              en: 'Improved libido and sexual performance',
              es: 'Mejora del libido y rendimiento sexual',
            },
            value: 'libido_performance',
          },
          {
            id: 'muscle_strength',
            label: { en: 'Muscle growth and strength', es: 'Crecimiento muscular y fuerza' },
            value: 'muscle_strength',
          },
          {
            id: 'fat_loss',
            label: {
              en: 'Fat loss and body composition',
              es: 'Pérdida de grasa y composición corporal',
            },
            value: 'fat_loss',
          },
          {
            id: 'mood_clarity',
            label: {
              en: 'Better mood and mental clarity',
              es: 'Mejor estado de ánimo y claridad mental',
            },
            value: 'mood_clarity',
          },
          {
            id: 'focus_concentration',
            label: { en: 'Sharper focus and concentration', es: 'Mayor enfoque y concentración' },
            value: 'focus_concentration',
          },
          {
            id: 'sleep_quality',
            label: { en: 'Improved sleep quality', es: 'Mejor calidad de sueño' },
            value: 'sleep_quality',
          },
          {
            id: 'vitality_anti_aging',
            label: {
              en: 'Overall vitality and anti-aging',
              es: 'Vitalidad general y anti-envejecimiento',
            },
            value: 'vitality_anti_aging',
          },
        ],
        validation: [
          {
  ...
  // ===== PRIOR TESTOSTERONE USE =====
  {
    ...
    title: {
      en: 'Have you used testosterone therapy before?',
      es: '¿Has usado terapia de testosterona antes?',
    },
    type: 'single-select',
    fields: [
      {
        id: 'prior_testosterone',
        type: 'radio',
        ...
        options: [
          {
            id: 'currently_on',
            label: {
              en: 'Yes, I am currently on testosterone therapy',
              es: 'Sí, actualmente estoy en terapia de testosterona',
            },
            value: 'currently_on',
          },
          {
            id: 'previously_used',
            label: {
              en: 'Yes, I have used it before but not currently',
              es: 'Sí, lo he usado antes pero no actualmente',
            },
            value: 'previously_used',
          },
          {
            id: 'never_used',
            label: {
              en: 'No, I have never used testosterone therapy',
              es: 'No, nunca he usado terapia de testosterona',
            },
            value: 'never_used',
          },
        ],
    ...
    nextStep: [
      {
        conditions: [
          {
            field: 'prior_testosterone',
            operator: 'in',
            value: ['currently_on', 'previously_used'],
          },
        ],
        target: 'trt-type',
      },
      {
        conditions: [{ field: 'prior_testosterone', operator: 'equals', value: 'never_used' }],
        target: 'blood-work',
      },
    ],
    prevStep: 'trt-goals',
  ...
  // ===== TRT TYPE (conditional) =====
  {
    ...
    path: 'trt-type',
    title: {
      en: 'What type of testosterone have you used?',
      es: '¿Qué tipo de testosterona has usado?',
    },
    type: 'single-select',
    fields: [
      {
        ...
        options: [
          {
            id: 'injections',
            label: {
              en: 'Injections (Cypionate/Enanthate)',
              es: 'Inyecciones (Cipionato/Enantato)',
            },
            value: 'injections',
          },
          {
            id: 'topical',
            label: { en: 'Topical gel or cream', es: 'Gel o crema tópica' },
            value: 'topical',
          },
  ...
  // ===== TRT DOSE =====
  {
    ...
    path: 'trt-dose',
    title: {
      en: 'What is your current or most recent dose and frequency?',
      es: '¿Cuál es tu dosis y frecuencia actual o más reciente?',
    },
    type: 'input',
    fields: [
      {
        ...
        placeholder: {
          en: 'Example: Testosterone Cypionate, 200mg/mL, 0.5mL twice per week',
          es: 'Ejemplo: Cipionato de Testosterona, 200mg/mL, 0.5mL dos veces por semana',
        },
        storageKey: 'trt_dose',
        validation: [
          {
            type: 'required',
            message: {
              en: 'Please enter your dose and frequency',
              es: 'Por favor ingresa tu dosis y frecuencia',
            },
          },
        ],
      },
  ...
  // ===== BLOOD WORK =====
  {
    ...
    path: 'blood-work',
    title: {
      en: 'Have you had your testosterone levels checked?',
      es: '¿Te has hecho un análisis de tus niveles de testosterona?',
    },
    type: 'single-select',
    fields: [
      {
        id: 'testosterone_blood_work',
        type: 'radio',
        ...
        options: [
          {
            id: 'within_60_days',
            label: { en: 'Yes, within the last 60 days', es: 'Sí, dentro de los últimos 60 días' },
            value: 'within_60_days',
          },
          {
            id: '3_to_6_months',
            label: { en: 'Yes, 3 to 6 months ago', es: 'Sí, hace 3 a 6 meses' },
            value: '3_to_6_months',
          },
          {
            id: 'over_6_months',
            label: { en: 'Yes, but over 6 months ago', es: 'Sí, pero hace más de 6 meses' },
            value: 'over_6_months',
          },
          {
            id: 'never',
            label: {
              en: 'No, I have never had my levels checked',
              es: 'No, nunca me he hecho un análisis de niveles',
            },
            value: 'never',
          },
        ],
    ...
    nextStep: [
      {
        conditions: [
          { field: 'testosterone_blood_work', operator: 'equals', value: 'within_60_days' },
        ],
        target: 'lab-upload',
      },
      {
        conditions: [
          {
            field: 'testosterone_blood_work',
            operator: 'in',
            value: ['3_to_6_months', 'over_6_months'],
          },
        ],
        target: 'blood-work-results',
      },
      {
        conditions: [{ field: 'testosterone_blood_work', operator: 'equals', value: 'never' }],
  ...
  // ===== LAB UPLOAD (within 60 days) =====
  {
    ...
    subtitle: {
      en: "If you have your lab results available, upload them here. If not, don't worry — you can submit them later.",
      es: 'Si tienes tus resultados de laboratorio disponibles, súbelos aquí. Si no, no te preocupes — puedes enviarlos después.',
    },
    type: 'custom',
  ...
  // ===== BLOOD WORK RESULTS =====
  {
    ...
    title: {
      en: 'What were your testosterone levels?',
      es: '¿Cuáles fueron tus niveles de testosterona?',
    },
    type: 'input',
    fields: [
      {
        id: 'testosterone_levels',
        type: 'textarea',
        label: { en: 'Testosterone Levels', es: 'Niveles de Testosterona' },
        placeholder: {
          en: 'Example: Total T: 280 ng/dL, Free T: 5.2 pg/mL',
          es: 'Ejemplo: T Total: 280 ng/dL, T Libre: 5.2 pg/mL',
        },
  ...
  // ===== PROSTATE HEALTH =====
  {
    ...
    title: {
      en: 'Do you have any prostate health concerns?',
      es: '¿Tienes alguna preocupación sobre la salud de tu próstata?',
    },
    type: 'single-select',
    fields: [
      {
        ...
        options: [
          { id: 'none', label: { en: 'None', es: 'Ninguna' }, value: 'none' },
          {
            ...
            label: { en: 'Enlarged prostate (BPH)', es: 'Próstata agrandada (HPB)' },
            value: 'enlarged_prostate',
          },
          {
            id: 'elevated_psa',
            label: { en: 'Elevated PSA levels', es: 'Niveles elevados de PSA' },
            value: 'elevated_psa',
          },
          {
            id: 'prostate_cancer',
            label: { en: 'History of prostate cancer', es: 'Historial de cáncer de próstata' },
  ...
  // ===== BLOOD CLOTS =====
  {
    ...
    path: 'blood-clots',
    title: {
      en: 'Do you have a history of blood clots, DVT, or pulmonary embolism?',
      es: '¿Tienes antecedentes de coágulos sanguíneos, TVP o embolia pulmonar?',
    },
    type: 'single-select',
    fields: [
      {
  ...
  // ===== SLEEP APNEA =====
  {
    ...
    path: 'sleep-apnea',
    title: {
      en: 'Have you been diagnosed with sleep apnea?',
      es: '¿Te han diagnosticado apnea del sueño?',
    },
    type: 'single-select',
    fields: [
      {
        ...
        options: [
          {
            id: 'yes_treated',
            label: { en: 'Yes, and I use a CPAP/treatment', es: 'Sí, y uso CPAP/tratamiento' },
            value: 'yes_treated',
          },
          {
            id: 'yes_untreated',
            label: { en: 'Yes, but untreated', es: 'Sí, pero sin tratamiento' },
            value: 'yes_untreated',
          },
          { id: 'no', label: { en: 'No', es: 'No' }, value: 'no' },
        ],
  ...
  // ===== HEART / CARDIOVASCULAR CONDITIONS =====
  {
    ...
    title: {
      en: 'Do you have any cardiovascular history?',
      es: '¿Tienes algún historial cardiovascular?',
    },
    type: 'multi-select',
    fields: [
      {
        ...
        options: [
          ...
          {
            id: 'heart_attack',
            label: { en: 'Heart attack', es: 'Ataque cardíaco' },
            value: 'heart_attack',
          },
          { id: 'stroke', label: { en: 'Stroke', es: 'Derrame cerebral' }, value: 'stroke' },
          {
            id: 'heart_disease',
            label: { en: 'Heart disease', es: 'Enfermedad cardíaca' },
            value: 'heart_disease',
          },
          {
            id: 'high_cholesterol',
            label: { en: 'High cholesterol', es: 'Colesterol alto' },
  ...
  // ===== FERTILITY CONCERNS =====
  {
    ...
    title: {
      en: 'Are you currently trying to conceive or planning to in the next 12 months?',
      es: '¿Estás tratando de concebir o planeas hacerlo en los próximos 12 meses?',
    },
    subtitle: {
      en: 'Testosterone therapy can affect sperm production. This is important for your provider to know.',
      es: 'La terapia de testosterona puede afectar la producción de esperma. Es importante que tu proveedor lo sepa.',
    },
    type: 'single-select',
    fields: [
      {
  ...
  },
  {
    ...
    subtitle: {
      en: 'Based on your responses, you may qualify for Testosterone Replacement Therapy. A licensed provider will review your information.',
      es: 'Según tus respuestas, puedes calificar para la Terapia de Reemplazo de Testosterona. Un proveedor licenciado revisará tu información.',
    },
    type: 'custom',
...
export const otMensTRTIntakeConfig: FormConfig = {
  ...
  version: '1.0.0',
  description:
    "Comprehensive medical intake for Overtime Men's Health Testosterone Replacement Therapy programs",
  treatmentType: 'trt',
  steps,
  startStep: 'trt-intro',
  languages: ['en'],
