...
const steps: FormStep[] = [
  // ===== INTRO / LANDING =====
  {
    id: 'peptide-intro',
    path: 'peptide-intro',
    title: { en: 'Support healthy aging and recovery.', es: 'Apoya el envejecimiento saludable y la recuperación.' },
    subtitle: { en: "Optimize your body's natural regulation.", es: 'Optimiza la regulación natural de tu cuerpo.' },
    type: 'custom',
  ...
  // ===== SYMPTOMS ASSESSMENT =====
  {
    ...
    type: 'multi-select',
    fields: [{
      id: 'peptide_symptoms', type: 'checkbox',
      label: { en: 'Symptoms', es: 'Síntomas' },
      storageKey: 'peptide_symptoms',
      options: [
        { id: 'brain_fog', label: { en: 'Brain fog', es: 'Niebla mental' }, value: 'brain_fog' },
        { id: 'chronic_fatigue', label: { en: 'Chronic fatigue or low energy', es: 'Fatiga crónica o baja energía' }, value: 'chronic_fatigue' },
        { id: 'poor_focus', label: { en: 'Difficulty focusing or poor concentration', es: 'Dificultad para concentrarse' }, value: 'poor_focus' },
        { id: 'low_endurance', label: { en: 'Low endurance or exercise tolerance', es: 'Baja resistencia o tolerancia al ejercicio' }, value: 'low_endurance' },
        { id: 'decreased_libido', label: { en: 'Decreased libido', es: 'Disminución del libido' }, value: 'decreased_libido' },
        { id: 'muscle_loss', label: { en: 'Loss of muscle mass', es: 'Pérdida de masa muscular' }, value: 'muscle_loss' },
        { id: 'muscle_weakness', label: { en: 'Muscle weakness', es: 'Debilidad muscular' }, value: 'muscle_weakness' },
        { id: 'sleep_disturbance', label: { en: 'Sleep disturbances or poor sleep quality', es: 'Trastornos del sueño o mala calidad del sueño' }, value: 'sleep_disturbance' },
        { id: 'weight_gain', label: { en: 'Weight gain or difficulty losing weight', es: 'Aumento de peso o dificultad para perder peso' }, value: 'weight_gain' },
      ],
  ...
  // ===== PEPTIDE THERAPY SELECTION =====
  {
    ...
    title: { en: 'Which peptide therapy are you interested in starting today?', es: '¿Qué terapia de péptidos te interesa comenzar hoy?' },
    type: 'single-select',
    fields: [{
      id: 'peptide_therapy', type: 'radio',
      ...
      options: [
        ...
        { id: 'not_sure', label: { en: "I'm not sure yet", es: 'No estoy seguro aún' }, value: 'not_sure' },
      ],
    }],
    autoAdvance: true,
    showContinueButton: false,
  ...
  // ===== SERMORELIN GOALS =====
  {
    ...
    title: { en: 'What are your goals with Sermorelin therapy?', es: '¿Cuáles son tus objetivos con la terapia de Sermorelin?' },
    type: 'multi-select',
    fields: [{
      id: 'sermorelin_goals', type: 'checkbox',
      label: { en: 'Sermorelin Goals', es: 'Objetivos de Sermorelin' },
      storageKey: 'sermorelin_goals',
      options: [
        { id: 'sleep', label: { en: 'Improved sleep quality', es: 'Mejorar la calidad del sueño' }, value: 'sleep' },
        { id: 'energy', label: { en: 'Increased energy and vitality', es: 'Mayor energía y vitalidad' }, value: 'energy' },
        { id: 'muscle', label: { en: 'Muscle growth or preservation', es: 'Crecimiento o preservación muscular' }, value: 'muscle' },
        { id: 'weight', label: { en: 'Weight management or fat loss', es: 'Control de peso o pérdida de grasa' }, value: 'weight' },
        { id: 'recovery', label: { en: 'Improved recovery or injury prevention', es: 'Mejor recuperación o prevención de lesiones' }, value: 'recovery' },
        { id: 'anti_aging', label: { en: 'Anti-aging or longevity support', es: 'Soporte anti-envejecimiento o longevidad' }, value: 'anti_aging' },
        { id: 'other', label: { en: 'Other (please specify)', es: 'Otro (por favor especifica)' }, value: 'other' },
      ],
  ...
  // ===== WHAT ARE YOU LOOKING TO OPTIMIZE =====
  {
    ...
    type: 'multi-select',
    fields: [{
      id: 'optimize_goals', type: 'checkbox',
      label: { en: 'Optimization Goals', es: 'Objetivos de Optimización' },
      storageKey: 'optimize_goals',
      options: [
        { id: 'recovery_tissue', label: { en: 'Support recovery and tissue repair', es: 'Apoyar la recuperación y reparación de tejidos' }, value: 'recovery_tissue' },
        { id: 'energy', label: { en: 'Increased energy and vitality', es: 'Mayor energía y vitalidad' }, value: 'energy' },
        { id: 'muscle', label: { en: 'Muscle growth or preservation', es: 'Crecimiento o preservación muscular' }, value: 'muscle' },
        { id: 'weight', label: { en: 'Weight management or fat loss', es: 'Control de peso o pérdida de grasa' }, value: 'weight' },
        { id: 'recovery', label: { en: 'Improved recovery or injury prevention', es: 'Mejor recuperación o prevención de lesiones' }, value: 'recovery' },
  ...
  // ===== SERMORELIN-SPECIFIC MEDICATIONS =====
  {
    ...
    title: { en: 'Are you currently taking any of the following medications?', es: '¿Estás tomando actualmente alguno de los siguientes medicamentos?' },
    subtitle: { en: "These may interfere with Sermorelin's effectiveness.", es: 'Estos pueden interferir con la efectividad de Sermorelin.' },
    type: 'multi-select',
    fields: [{
      id: 'sermorelin_medications', type: 'checkbox',
      ...
      options: [
        ...
        { id: 'clonidine_levodopa', label: { en: 'Clonidine or Levodopa', es: 'Clonidina o Levodopa' }, value: 'clonidine_levodopa' },
        { id: 'somatostatin_analogs', label: { en: 'Octreotide, Lanreotide, or Pasireotide', es: 'Octreotida, Lanreotida o Pasireotida' }, value: 'somatostatin_analogs' },
        { id: 'glucocorticoids', label: { en: 'Glucocorticoids (for example prednisone or dexamethasone)', es: 'Glucocorticoides (por ejemplo prednisona o dexametasona)' }, value: 'glucocorticoids' },
        { id: 'cox_inhibitors', label: { en: 'COX inhibitors (for example aspirin, ibuprofen, Advil, Celebrex)', es: 'Inhibidores COX (por ejemplo aspirina, ibuprofeno, Advil, Celebrex)' }, value: 'cox_inhibitors' },
      ],
      validation: [{ type: 'required', message: { en: 'Please select at least one option', es: 'Por favor selecciona al menos una opción' } }],
    }],
    autoAdvance: false,
  ...
  // ===== PRESCRIPTION MEDICATIONS =====
  {
    ...
    nextStep: [
      ...
      { conditions: [{ field: 'has_prescription_meds', operator: 'equals', value: 'no' }], target: 'vitamin-b12' },
    ],
  ...
  // ===== PRESCRIPTION DETAILS (conditional) =====
  {
    ...
    subtitle: { en: 'Please list the name, and how often you take each one.', es: 'Por favor lista el nombre y con qué frecuencia tomas cada uno.' },
    type: 'input',
    fields: [{
      id: 'prescription_details', type: 'textarea',
      label: { en: 'Prescription Details', es: 'Detalles de Receta' },
      placeholder: { en: 'Example: Testosterone Cypionate, 200mg. Injection once per week.', es: 'Ejemplo: Cipionato de Testosterona, 200mg. Inyección una vez por semana.' },
      storageKey: 'prescription_details',
      validation: [{ type: 'required', message: { en: 'Please list your medications', es: 'Por favor lista tus medicamentos' } }],
    }],
    autoAdvance: false,
    showContinueButton: true,
  ...
  // ===== VITAMIN B-12 =====
  {
    id: 'vitamin-b12',
    path: 'vitamin-b12',
    title: { en: 'Have you ever been diagnosed with a Vitamin B-12 deficiency or absorption disorder?', es: '¿Alguna vez te han diagnosticado una deficiencia de Vitamina B-12 o un trastorno de absorción?' },
    subtitle: { en: "Certain digestive conditions, such as Crohn's disease or celiac disease, may affect B-12 levels.", es: 'Ciertas condiciones digestivas, como la enfermedad de Crohn o la enfermedad celíaca, pueden afectar los niveles de B-12.' },
    type: 'single-select',
    fields: [{
      id: 'vitamin_b12_deficiency', type: 'radio',
  ...
  // ===== SERMORELIN-SPECIFIC CONDITIONS =====
  {
    ...
    subtitle: { en: 'These questions are important for medical safety and eligibility.', es: 'Estas preguntas son importantes para la seguridad médica y elegibilidad.' },
    type: 'multi-select',
    fields: [{
      id: 'sermorelin_conditions', type: 'checkbox',
      label: { en: 'Sermorelin Conditions', es: 'Condiciones de Sermorelin' },
      storageKey: 'sermorelin_conditions',
      options: [
        { id: 'none', label: { en: 'None of these apply to me', es: 'Ninguno de estos aplica' }, value: 'none' },
        { id: 'hypothyroidism', label: { en: 'I have hypothyroidism', es: 'Tengo hipotiroidismo' }, value: 'hypothyroidism', description: { en: '(must be well-controlled prior to starting Sermorelin)', es: '(debe estar bien controlado antes de iniciar Sermorelin)' } },
        { id: 'glioma', label: { en: 'I have a history of glioma', es: 'Tengo antecedentes de glioma' }, value: 'glioma', description: { en: '(Sermorelin is contraindicated)', es: '(Sermorelin está contraindicado)' } },
        { id: 'cancer', label: { en: 'I have or have had another type of cancer or tumor', es: 'Tengo o he tenido otro tipo de cáncer o tumor' }, value: 'cancer' },
      ],
      validation: [{ type: 'required', message: { en: 'Please select at least one option', es: 'Por favor selecciona al menos una opción' } }],
    }],
    autoAdvance: false,
  ...
  // ===== CANCER TREATMENT =====
  {
    ...
    title: { en: 'Are you currently undergoing treatment for cancer, including chemotherapy or radiation therapy?', es: '¿Estás actualmente en tratamiento contra el cáncer, incluyendo quimioterapia o radioterapia?' },
    type: 'single-select',
    fields: [{
      id: 'cancer_treatment', type: 'radio',
  ...
  // ===== LIFESTYLE FACTORS =====
  {
    ...
    title: { en: 'Do any of the following lifestyle factors apply to you?', es: '¿Aplica alguno de los siguientes factores de estilo de vida?' },
    subtitle: { en: 'This information is confidential and helps ensure safe prescribing.', es: 'Esta información es confidencial y ayuda a garantizar una prescripción segura.' },
    type: 'single-select',
    fields: [{
      id: 'lifestyle_factors', type: 'radio',
      label: { en: 'Lifestyle Factors', es: 'Factores de Estilo de Vida' },
      storageKey: 'lifestyle_factors',
      options: [
        { id: 'none', label: { en: 'None of these apply to me', es: 'Ninguno de estos aplica' }, value: 'none' },
        { id: 'binge_drinking', label: { en: 'I binge drink alcohol (4 or more drinks in one sitting)', es: 'Bebo alcohol en exceso (4 o más bebidas en una sesión)' }, value: 'binge_drinking' },
        { id: 'opiates', label: { en: 'I use opiates (prescription or non-prescription)', es: 'Uso opiáceos (recetados o no recetados)' }, value: 'opiates' },
  ...
  // ===== ALLERGY DETAILS (conditional) =====
  {
    ...
    type: 'input',
    fields: [{
      id: 'allergy_details', type: 'textarea',
      label: { en: 'Allergy Details', es: 'Detalles de Alergia' },
      placeholder: { en: 'Tell us more', es: 'Cuéntanos más' },
      storageKey: 'allergy_details',
      validation: [{ type: 'required', message: { en: 'Please describe your allergies', es: 'Por favor describe tus alergias' } }],
    }],
    autoAdvance: false,
    showContinueButton: true,
    nextStep: 'lab-work',
  ...
  // ===== COMMITMENT INFO =====
  {
    ...
    title: { en: 'We are committed to recovery, balance & long-term health', es: 'Estamos comprometidos con la recuperación, el equilibrio y la salud a largo plazo' },
    type: 'custom',
  ...
  // ===== REFERRAL SOURCE (reuses OT pattern) =====
  {
    ...
    prevStep: 'commitment-info', progressPercent: 88,
  },
  {
    ...
    nextStep: 'review', prevStep: 'referral-source', progressPercent: 90,
  },
  ...
  // ===== REVIEW & SUBMISSION =====
  {
    ...
    autoAdvance: false, showContinueButton: true,
    nextStep: 'finding-provider', prevStep: 'commitment-info', progressPercent: 94,
  },
  {
    ...
    nextStep: 'qualified', prevStep: 'review', progressPercent: 97,
  },
  {
    id: 'qualified', path: 'qualified',
    title: { en: 'Great news!', es: '¡Excelentes noticias!' },
    subtitle: { en: 'Based on your responses, you may qualify for Sermorelin therapy. A licensed provider will review your information.', es: 'Según tus respuestas, puedes calificar para la terapia de Sermorelin. Un proveedor licenciado revisará tu información.' },
...
export const otMensPeptideIntakeConfig: FormConfig = {
  ...
  version: '1.0.0',
  description: 'Comprehensive medical intake for Overtime Men\'s Health Sermorelin/peptide therapy programs',
