...
const steps: FormStep[] = [
  ...
  {
    id: 'semaglutide-dosage', path: 'semaglutide-dosage',
    title: { en: 'What is your current or most recent semaglutide dose?', es: '¿Cuál es tu dosis actual o más reciente de semaglutida?' },
    type: 'single-select',
    fields: [{ id: 'semaglutide_dosage', type: 'radio', label: { en: 'Semaglutide Dosage', es: 'Dosis de Semaglutida' }, storageKey: 'semaglutide_dosage', options: [
    ...
    nextStep: 'semaglutide-side-effects', prevStep: 'glp1-type', progressPercent: 66,
  },
  {
    id: 'semaglutide-side-effects', path: 'semaglutide-side-effects',
    ...
    subtitle: { en: 'Select all that apply.', es: 'Selecciona todos los que apliquen.' },
    type: 'multi-select',
    fields: [{ id: 'semaglutide_side_effects', type: 'checkbox', label: { en: 'Side Effects', es: 'Efectos Secundarios' }, storageKey: 'semaglutide_side_effects', options: [
    ...
    nextStep: 'semaglutide-success', prevStep: 'semaglutide-dosage', progressPercent: 67,
  },
  {
    id: 'semaglutide-success', path: 'semaglutide-success',
    title: { en: 'How would you describe your success with semaglutide?', es: '¿Cómo describirías tu éxito con semaglutida?' },
    type: 'single-select',
    fields: [{ id: 'semaglutide_success', type: 'radio', label: { en: 'Success Level', es: 'Nivel de Éxito' }, storageKey: 'semaglutide_success', options: [
    ...
    autoAdvance: true, showContinueButton: false,
    nextStep: 'recreational-drugs', prevStep: 'semaglutide-side-effects', progressPercent: 68,
  },
  {
    id: 'tirzepatide-dosage', path: 'tirzepatide-dosage',
    title: { en: 'What is your current or most recent tirzepatide dose?', es: '¿Cuál es tu dosis actual o más reciente de tirzepatida?' },
    type: 'single-select',
    fields: [{ id: 'tirzepatide_dosage', type: 'radio', label: { en: 'Tirzepatide Dosage', es: 'Dosis de Tirzepatida' }, storageKey: 'tirzepatide_dosage', options: [
    ...
    autoAdvance: true, showContinueButton: false,
    nextStep: 'tirzepatide-side-effects', prevStep: 'glp1-type', progressPercent: 66,
  },
  {
    id: 'tirzepatide-side-effects', path: 'tirzepatide-side-effects',
    ...
    subtitle: { en: 'Select all that apply.', es: 'Selecciona todos los que apliquen.' },
    type: 'multi-select',
    fields: [{ id: 'tirzepatide_side_effects', type: 'checkbox', label: { en: 'Side Effects', es: 'Efectos Secundarios' }, storageKey: 'tirzepatide_side_effects', options: [
      { id: 'nausea', label: { en: 'Nausea', es: 'Náuseas' }, value: 'nausea' },
      { id: 'vomiting', label: { en: 'Vomiting', es: 'Vómitos' }, value: 'vomiting' },
      { id: 'diarrhea', label: { en: 'Diarrhea', es: 'Diarrea' }, value: 'diarrhea' },
      { id: 'constipation', label: { en: 'Constipation', es: 'Estreñimiento' }, value: 'constipation' },
    ...
    autoAdvance: false, showContinueButton: true,
    nextStep: 'tirzepatide-success', prevStep: 'tirzepatide-dosage', progressPercent: 67,
  },
  {
    id: 'tirzepatide-success', path: 'tirzepatide-success',
    title: { en: 'How would you describe your success with tirzepatide?', es: '¿Cómo describirías tu éxito con tirzepatida?' },
    type: 'single-select',
    fields: [{ id: 'tirzepatide_success', type: 'radio', label: { en: 'Success Level', es: 'Nivel de Éxito' }, storageKey: 'tirzepatide_success', options: [
      { id: 'very_successful', label: { en: 'Very successful', es: 'Muy exitoso' }, value: 'very_successful' },
      { id: 'somewhat_successful', label: { en: 'Somewhat successful', es: 'Algo exitoso' }, value: 'somewhat_successful' },
      { id: 'not_successful', label: { en: 'Not successful', es: 'No exitoso' }, value: 'not_successful' },
      { id: 'hard_consistency', label: { en: 'Hard to stay consistent', es: 'Difícil mantener la consistencia' }, value: 'hard_consistency' },
    ...
    autoAdvance: true, showContinueButton: false,
    nextStep: 'recreational-drugs', prevStep: 'tirzepatide-side-effects', progressPercent: 68,
  },
  {
    id: 'dosage-satisfaction', path: 'dosage-satisfaction',
    title: { en: 'Are you satisfied with your current GLP-1 dose?', es: '¿Estás satisfecho con tu dosis actual de GLP-1?' },
    type: 'single-select',
    fields: [{ id: 'dosage_satisfaction', type: 'radio', label: { en: 'Dosage Satisfaction', es: 'Satisfacción con la Dosis' }, storageKey: 'dosage_satisfaction', options: [
    ...
    autoAdvance: true, showContinueButton: false,
    nextStep: 'recreational-drugs', prevStep: 'glp1-type', progressPercent: 68,
  },

  // ===== SECTION 7: LIFESTYLE =====
  {
    id: 'recreational-drugs', path: 'recreational-drugs',
    ...
    subtitle: { en: 'Select all that apply.', es: 'Selecciona todos los que apliquen.' },
    type: 'multi-select',
    fields: [{ id: 'recreational_drugs', type: 'checkbox', label: { en: 'Recreational Drugs', es: 'Drogas Recreativas' }, storageKey: 'recreational_drugs', options: [
    ...
    autoAdvance: false, showContinueButton: true,
    nextStep: 'weight-loss-history', prevStep: 'glp1-history', progressPercent: 70,
  },
  {
    id: 'weight-loss-history', path: 'weight-loss-history',
    title: { en: 'Have you tried to lose weight before?', es: '¿Has intentado perder peso antes?' },
    subtitle: { en: 'Select all that apply.', es: 'Selecciona todos los que apliquen.' },
    type: 'multi-select',
    fields: [{ id: 'weight_loss_methods', type: 'checkbox', label: { en: 'Weight Loss Methods', es: 'Métodos de Pérdida de Peso' }, storageKey: 'weight_loss_methods', options: [
    ...
    autoAdvance: false, showContinueButton: true,
    nextStep: 'weight-loss-support', prevStep: 'recreational-drugs', progressPercent: 72,
  },
  {
    id: 'weight-loss-support', path: 'weight-loss-support',
    ...
    subtitle: { en: 'Select all that apply.', es: 'Selecciona todos los que apliquen.' },
    type: 'multi-select',
    fields: [{ id: 'weight_loss_support', type: 'checkbox', label: { en: 'Support Preferences', es: 'Preferencias de Apoyo' }, storageKey: 'weight_loss_support', options: [
    ...
    autoAdvance: false, showContinueButton: true,
    nextStep: 'side-effects-info', prevStep: 'weight-loss-history', progressPercent: 74,
  },
  {
    id: 'side-effects-info', path: 'side-effects-info',
    ...
    type: 'custom', component: 'SideEffectsStep', fields: [],
    autoAdvance: false, showContinueButton: true,
    nextStep: 'dosage-interest', prevStep: 'weight-loss-support', progressPercent: 76,
  },
  {
    id: 'dosage-interest', path: 'dosage-interest',
    title: { en: 'Are you interested in a personalized dosage plan?', es: '¿Te interesa un plan de dosificación personalizado?' },
    type: 'single-select',
    fields: [{ id: 'dosage_interest', type: 'radio', label: { en: 'Dosage Interest', es: 'Interés en Dosificación' }, storageKey: 'dosage_interest', options: [
      { id: 'yes', label: { en: 'Yes', es: 'Sí' }, value: 'yes' },
      { id: 'no', label: { en: 'No', es: 'No' }, value: 'no' },
      { id: 'not_sure', label: { en: 'Not sure', es: 'No estoy seguro' }, value: 'not_sure' },
    ] }],
    autoAdvance: true, showContinueButton: false,
    nextStep: 'glp1-data', prevStep: 'side-effects-info', progressPercent: 78,
  },
  {
    id: 'glp1-data', path: 'glp1-data',
    ...
    type: 'custom', component: 'GLP1DataStep', fields: [],
    autoAdvance: false, showContinueButton: true,
    nextStep: 'alcohol-consumption', prevStep: 'dosage-interest', progressPercent: 80,
  },
  {
    id: 'alcohol-consumption', path: 'alcohol-consumption',
    ...
    type: 'single-select',
    fields: [{ id: 'alcohol_consumption', type: 'radio', label: { en: 'Alcohol Consumption', es: 'Consumo de Alcohol' }, storageKey: 'alcohol_consumption', options: [
  ...
  // ===== SECTION 8: REVIEW & SUBMISSION (OT-specific ending) =====
  {
    ...
    type: 'custom', component: 'SafetyQualityStep', fields: [],
    autoAdvance: false, showContinueButton: true,
    nextStep: 'medical-team', prevStep: 'alcohol-consumption', progressPercent: 83,
  },
  {
    id: 'medical-team', path: 'medical-team',
    title: { en: 'Your dedicated medical team is ready to support you.', es: 'Tu equipo médico dedicado está listo para apoyarte.' },
    type: 'custom', component: 'MedicalTeamStep', fields: [],
    autoAdvance: false, showContinueButton: true,
    nextStep: 'common-side-effects', prevStep: 'safety-quality', progressPercent: 84,
  },
  {
    id: 'common-side-effects', path: 'common-side-effects',
    ...
    type: 'single-select',
    fields: [{ id: 'common_side_effects', type: 'radio', label: { en: 'Side Effect Concerns', es: 'Preocupaciones sobre Efectos Secundarios' }, storageKey: 'common_side_effects', options: [
    ...
    autoAdvance: true, showContinueButton: false,
    nextStep: 'personalized-treatment', prevStep: 'medical-team', progressPercent: 86,
  },
  {
    id: 'personalized-treatment', path: 'personalized-treatment',
    ...
    type: 'custom', component: 'PersonalizedTreatmentStep', fields: [],
    autoAdvance: false, showContinueButton: true,
  ...
  },
  {
    ...
    autoAdvance: false, showContinueButton: true,
    nextStep: 'health-improvements', prevStep: 'referral-source', progressPercent: 90,
  },
  {
    id: 'health-improvements', path: 'health-improvements',
    title: { en: 'Aside from losing weight, is there another area of your health you\'d like to improve?', es: 'Aparte de perder peso, ¿hay otra área de tu salud que te gustaría mejorar?' },
    type: 'custom', component: 'HealthImprovementsStep',
    fields: [{
      id: 'health_improvements', type: 'checkbox',
      label: { en: 'Health Improvements', es: 'Mejoras de Salud' },
      storageKey: 'health_improvements',
      options: [
        { id: 'hair_regrowth', label: { en: 'Hair regrowth', es: 'Crecimiento del cabello' }, value: 'hair_regrowth' },
        { id: 'sexual_health', label: { en: 'Sexual Health', es: 'Salud sexual' }, value: 'sexual_health' },
        { id: 'testosterone_support', label: { en: 'Testosterone support', es: 'Soporte de testosterona' }, value: 'testosterone_support' },
        { id: 'muscle_fat', label: { en: 'More muscle, less fat', es: 'Más músculo, menos grasa' }, value: 'muscle_fat' },
    ...
    autoAdvance: false, showContinueButton: true,
    nextStep: 'review', prevStep: 'referral-source', progressPercent: 91,
  },
  {
    ...
    autoAdvance: false, showContinueButton: true,
    nextStep: 'finding-provider', prevStep: 'health-improvements', progressPercent: 94,
  },
  {
