...
const steps: FormStep[] = [
  // ===== INTRO / LANDING (English only — no language selector for OT) =====
  {
    ...
    title: {
      ...
      es: "Let's evaluate your treatment options.",
    },
    subtitle: {
      en: 'Discover personalized solutions based on your goals, habits, and health history.',
      es: 'Discover personalized solutions based on your goals, habits, and health history.',
    },
    type: 'info',
    fields: [],
    autoAdvance: false,
  ...
  },
  {
    ...
    autoAdvance: false,
    showContinueButton: true,
    nextStep: 'health-improvements',
    prevStep: 'referral-source',
    progressPercent: 90,
  },
  {
    id: 'health-improvements',
    path: 'health-improvements',
    title: {
    ...
    type: 'custom',
    component: 'HealthImprovementsStep',
    fields: [
      {
        id: 'health_improvements',
        type: 'checkbox',
        label: { en: 'Health Improvements', es: 'Mejoras de Salud' },
        storageKey: 'health_improvements',
        options: [
          {
            id: 'hair_regrowth',
            label: { en: 'Hair regrowth', es: 'Crecimiento del cabello' },
            value: 'hair_regrowth',
          },
          {
            id: 'sexual_health',
            label: { en: 'Sexual Health', es: 'Salud sexual' },
            value: 'sexual_health',
          },
          {
            id: 'testosterone_support',
            label: { en: 'Testosterone support', es: 'Soporte de testosterona' },
            value: 'testosterone_support',
          },
          {
            id: 'muscle_fat',
            label: { en: 'More muscle, less fat', es: 'Más músculo, menos grasa' },
            value: 'muscle_fat',
          },
          { id: 'longevity', label: { en: 'Longevity', es: 'Longevidad' }, value: 'longevity' },
          { id: 'none', label: { en: 'None of these', es: 'Ninguno de estos' }, value: 'none' },
        ],
        validation: [
          {
            type: 'required',
...
export const otMensIntakeConfig: FormConfig = {
  ...
  version: '1.0.0',
  description:
    "Comprehensive medical intake for Overtime Men's Health weight loss programs with GLP-1 assessment",
