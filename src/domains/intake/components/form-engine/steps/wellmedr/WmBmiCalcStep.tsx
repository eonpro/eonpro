...
export default function WmBmiCalcStep({ basePath, nextStep, progressPercent }: WmBmiCalcStepProps) {
  ...
  const borderStyle = "border: 1px solid rgba(0,0,0,0.08)";
            ...
            <div>
              ...
              <div className="relative">
                <select value={feet} onChange={(e) => setFeet(e.target.value)}
                  className={inputCls} style={{ [borderStyle]: '', border: '1px solid rgba(0,0,0,0.08)', appearance: 'none', paddingRight: '2.5rem', cursor: 'pointer', color: feet ? '#101010' : '#aaa' }}
