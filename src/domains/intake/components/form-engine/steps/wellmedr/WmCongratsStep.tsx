  ...
  return (
    <div className="min-h-[100dvh] flex flex-col" style={{ backgroundColor: '#F7F7F9' }}>
      ...
      <div className="flex-1 flex flex-col w-full max-w-[600px] mx-auto px-6 sm:px-8 pb-6 pt-6">
        ...
        <div className="w-full mb-3 wm-marquee">
          <div className="wm-marquee-track">
            {doubledTestimonials.map((t, i) => (
              <div key={`r1-${i}`} className="flex-shrink-0 w-[200px] sm:w-[240px]">
        ...
        <div className="w-full mb-4 wm-marquee">
          <div className="wm-marquee-track-reverse">
            {[...doubledTestimonials].reverse().map((t, i) => (
              <div key={`r2-${i}`} className="flex-shrink-0 w-[200px] sm:w-[240px]">
                <div className="rounded-2xl overflow-hidden">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src={t.src} alt={`${t.stat} ${t.time}`} className="w-full h-auto object-cover" />
                </div>
