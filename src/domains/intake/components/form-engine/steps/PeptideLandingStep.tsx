...
export default function PeptideLandingStep({ basePath, nextStep }: PeptideLandingStepProps) {
      ...
      <div className="mx-auto flex w-full max-w-md flex-1 flex-col px-6 pb-6 pt-8 lg:max-w-2xl lg:px-8 lg:pt-12">
        ...
        <div className="mb-6 text-left">
          ...
          >
            {isSpanish ? (
              <>
                Apoya el envejecimiento
                <br />
                saludable y la recuperación.
              </>
            ) : (
              <>
          ...
          >
            {isSpanish ? (
              <>
                Descubre si la terapia con Sermorelin es adecuada
                <br />
                para ti según tus síntomas y estilo de vida.
              </>
            ) : (
              <>
                Discover if Sermorelin therapy is right for you
                <br />
