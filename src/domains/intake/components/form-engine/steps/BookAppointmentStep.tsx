...
const T = {
  ...
  item1: {
    en: 'Personalized treatment plan review',
    es: 'Revisión de plan de tratamiento personalizado',
  },
  item2: { en: 'Medication recommendation', es: 'Recomendación de medicamentos' },
  item3: {
    en: 'Dosage guidance from a licensed provider',
    es: 'Guía de dosificación de un proveedor licenciado',
  },
      ...
      script.onload = () => {
        ...
        const frame = () => {
          confetti({
            ...
            gravity: 1.5,
            startVelocity: 25,
            colors: ['#cab172', '#f5ecd8', '#413d3d', '#d4a843', '#e8d5a0'],
          });
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <div className="mx-auto flex w-full max-w-[480px] flex-1 flex-col px-6 py-8 lg:max-w-[560px] lg:px-8">
        {/* Success header */}
        <div
          className={`mb-8 space-y-4 transition-all duration-700 ease-out ${animate ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'}`}
        >
          <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#cab172]/20">
            <svg
              className="h-8 w-8 text-[#cab172]"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <h1 className="text-2xl font-bold text-[#413d3d] lg:text-3xl">
        ...
        <div
          className={`mb-6 space-y-4 rounded-2xl border-2 border-[#cab172] bg-[#f5ecd8]/30 p-6 transition-all delay-300 duration-700 ease-out ${animate ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'}`}
        >
          ...
          <a
            ...
            className="block w-full rounded-full px-6 py-4 text-center text-[15px] font-semibold text-white transition-all hover:-translate-y-0.5 hover:shadow-lg"
        ...
        {/* Included list */}
        <div
          className={`space-y-3 transition-all delay-500 duration-700 ease-out ${animate ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'}`}
        >
          <h3 className="text-sm font-semibold uppercase tracking-wide text-[#413d3d]">
            {t('included')}
          </h3>
      ...
      <div className="mx-auto w-full max-w-[480px] space-y-4 px-6 pb-8 lg:max-w-[560px] lg:px-8">
        <p className="text-center text-xs text-gray-400">{t('questions')}</p>
