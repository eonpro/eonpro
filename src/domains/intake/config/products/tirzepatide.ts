  ...
  plans: [
    {
      ...
      billing: 'monthly',
      stripePriceId:
        process.env.NEXT_PUBLIC_STRIPE_PRICE_TIRZ_MONTHLY || 'price_tirzepatide_monthly',
    ...
    },
    {
      ...
      billing: 'once',
      stripePriceId:
        process.env.NEXT_PUBLIC_STRIPE_PRICE_TIRZ_ONETIME || 'price_tirzepatide_onetime',
