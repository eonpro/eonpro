...
const PRESCRIPTION_PEPTIDES: BillingPlan[] = [
  ...
  // --- Glutathione ---
  {
    ...
    category: 'ot_prescription_peptides',
    price: 22500,
    description: 'Glutathione – 3 Month',
  ...
  },
  {
    ...
    category: 'ot_prescription_peptides',
    price: 42900,
    description: 'Glutathione – 6 Month',
  ...
  },
  {
    ...
    category: 'ot_prescription_peptides',
    price: 81900,
    description: 'Glutathione – 12 Month',
  ...
  // --- Sermorelin ---
  {
    ...
    category: 'ot_prescription_peptides',
    price: 24900,
    description: 'Sermorelin – 1 Month',
  ...
  },
  {
    ...
    category: 'ot_prescription_peptides',
    price: 64900,
    description: 'Sermorelin – 3 Month',
  ...
  },
  {
    ...
    category: 'ot_prescription_peptides',
    price: 125900,
    description: 'Sermorelin – 6 Month',
  ...
  },
  {
    ...
    category: 'ot_prescription_peptides',
    price: 250000,
    description: 'Sermorelin – 12 Month',
...
const RESEARCH: BillingPlan[] = [
  // --- Visceral Fat Loss ---
  {
    id: 'ot_visceral_fat_3mo',
    name: 'Visceral Fat Loss – 3 Month',
    category: 'ot_research',
    price: 80900,
    description: 'Visceral Fat Loss – 3 Month',
    slug: 'ot_visceral_fat_3mo',
    months: 3,
    stripeProductId: 'prod_UDP0ECQ8EHfq2e',
    stripePriceId: 'price_1TEyEGDQIH4O9FhrDldjqvKK',
  },
  ...
  // --- Skin ---
  {
    ...
    category: 'ot_research',
    price: 29900,
    description: 'Skin – 3 Month',
    slug: 'ot_skin_cu_3mo',
    months: 3,
    stripeProductId: 'prod_UDPI2OmimpjQzN',
    stripePriceId: 'price_1TEyU2DQIH4O9Fhr9a2miSKV',
  },
  {
    id: 'ot_skin_cu_6mo',
    name: 'Skin – 6 Month',
    category: 'ot_research',
    price: 57500,
    description: 'Skin – 6 Month',
    slug: 'ot_skin_cu_6mo',
    months: 6,
    isRecurring: true,
    stripeProductId: 'prod_UDPI2OmimpjQzN',
    stripePriceId: 'price_1TEywGDQIH4O9FhrjfrPfowr',
  },
  {
    id: 'ot_skin_cu_12mo',
    name: 'Skin – 12 Month',
    category: 'ot_research',
    price: 109900,
    description: 'Skin – 12 Month',
    slug: 'ot_skin_cu_12mo',
    months: 12,
    isRecurring: true,
    stripeProductId: 'prod_UDPI2OmimpjQzN',
    stripePriceId: 'price_1TEyxkDQIH4O9FhrJiRznm1D',
  },

  // --- Sun Kissed ---
  {
    id: 'ot_sun_kissed_3mo',
    name: 'Sun Kissed – 3 Month',
    category: 'ot_research',
    price: 19900,
    description: 'Sun Kissed – 3 Month',
    slug: 'ot_sun_kissed_3mo',
    months: 3,
    stripeProductId: 'prod_UDPqbr10c25myS',
    stripePriceId: 'price_1TEz0UDQIH4O9FhrfJ7vgWSW',
  },

  // --- Platinum Recomp ---
  {
    id: 'ot_platinum_recomp_1mo',
    name: 'Platinum Recomp – 1 Month',
    category: 'ot_research',
    price: 39900,
    description: 'Platinum Recomp – 1 Month',
    slug: 'ot_platinum_recomp_1mo',
    months: 1,
    stripeProductId: 'prod_UDPsQ4rq2C2azl',
    stripePriceId: 'price_1THldMDQIH4O9Fhr7Dtj0RUc',
  },
  {
    id: 'ot_platinum_recomp_3mo',
    name: 'Platinum Recomp – 3 Month',
    category: 'ot_research',
    price: 99900,
    description: 'Platinum Recomp – 3 Month',
    slug: 'ot_platinum_recomp_3mo',
    months: 3,
    stripeProductId: 'prod_UDPsQ4rq2C2azl',
    stripePriceId: 'price_1TEz2qDQIH4O9FhrNXBc5Kom',
  },

  // --- Healing Protocol ---
  {
    id: 'ot_healing_bpc_1mo',
    name: 'Healing Protocol – 1 Month',
    category: 'ot_research',
    price: 20000,
    description: 'Healing Protocol – 1 Month',
    slug: 'ot_healing_bpc_1mo',
    months: 1,
    stripeProductId: 'prod_UDPv4e15QMvqOT',
    stripePriceId: 'price_1TEz5oDQIH4O9FhrRJOvFJmQ',
  },
  {
    id: 'ot_healing_bpc_3mo',
    name: 'Healing Protocol – 3 Month',
    category: 'ot_research',
    price: 52500,
    description: 'Healing Protocol – 3 Month',
    slug: 'ot_healing_bpc_3mo',
    months: 3,
    stripeProductId: 'prod_UDPv4e15QMvqOT',
    stripePriceId: 'price_1TEz71DQIH4O9FhrmVjsijy7',
  },

  // --- Healing Protocol Plus ---
  {
    id: 'ot_healing_plus_1mo',
    name: 'Healing Protocol Plus – 1 Month',
    category: 'ot_research',
    price: 29900,
    description: 'Healing Protocol Plus – 1 Month',
    slug: 'ot_healing_plus_1mo',
    months: 1,
    stripeProductId: 'prod_UDQUBbkcTe5Cal',
    stripePriceId: 'price_1TEzdLDQIH4O9Fhr7WDxZe9G',
  },
  {
    id: 'ot_healing_plus_3mo',
    name: 'Healing Protocol Plus – 3 Month',
    category: 'ot_research',
    price: 80900,
    description: 'Healing Protocol Plus – 3 Month',
    slug: 'ot_healing_plus_3mo',
    months: 3,
    stripeProductId: 'prod_UDQUBbkcTe5Cal',
    stripePriceId: 'price_1TEzdkDQIH4O9Fhr1VnTy47y',
  },

  // --- Longevity Protocol ---
  {
    id: 'ot_longevity_epithalon',
    name: 'Longevity Protocol – 2 Week Cycle',
    category: 'ot_research',
    price: 52500,
    description: 'Longevity Protocol – 2 Week Cycle',
    slug: 'ot_longevity_epithalon',
    months: 1,
    stripeProductId: 'prod_UDPyPhxzhd9zJl',
    stripePriceId: 'price_1TEz8WDQIH4O9FhrBTKnQg6C',
  },

  // --- Anti-Inflammation ---
  {
    id: 'ot_anti_inflam_1mo',
    name: 'Anti-Inflammation – 1 Month',
    category: 'ot_research',
    price: 20000,
    description: 'Anti-Inflammation – 1 Month',
    slug: 'ot_anti_inflam_1mo',
    months: 1,
    stripeProductId: 'prod_UDQ02QiiATMBos',
    stripePriceId: 'price_1TEzAlDQIH4O9FhrA3B57d5L',
  },
  {
    id: 'ot_anti_inflam_3mo',
    name: 'Anti-Inflammation – 3 Month',
    category: 'ot_research',
    price: 52500,
    description: 'Anti-Inflammation – 3 Month',
    slug: 'ot_anti_inflam_3mo',
    months: 3,
    stripeProductId: 'prod_UDQ02QiiATMBos',
    stripePriceId: 'price_1TEzEKDQIH4O9FhrWJWTDWUG',
  },

  // --- Cognition Optimization ---
  {
    id: 'ot_cognition_semax_1mo',
    name: 'Cognition Optimization – 1 Month',
    category: 'ot_research',
    price: 19900,
    description: 'Cognition Optimization – 1 Month',
    slug: 'ot_cognition_semax_1mo',
    months: 1,
    stripeProductId: 'prod_UDQ8CW5fUSHczB',
    stripePriceId: 'price_1TEzIIDQIH4O9FhrCK2pRIoQ',
  },
  {
    id: 'ot_cognition_semax_3mo',
    name: 'Cognition Optimization – 3 Month',
    category: 'ot_research',
    price: 39900,
    description: 'Cognition Optimization – 3 Month',
    slug: 'ot_cognition_semax_3mo',
    months: 3,
    stripeProductId: 'prod_UDQ8CW5fUSHczB',
    stripePriceId: 'price_1TEzIXDQIH4O9Fhr0RYznAtz',
  },

  // --- Calm Protocol ---
  {
    id: 'ot_calm_selank_1mo',
    name: 'Calm Protocol – 1 Month',
    category: 'ot_research',
    price: 19900,
    description: 'Calm Protocol – 1 Month',
    slug: 'ot_calm_selank_1mo',
    months: 1,
    stripeProductId: 'prod_UDQB7TCKoSIGeh',
    stripePriceId: 'price_1TEzLQDQIH4O9Fhr8ZG69pyu',
  },
  {
    id: 'ot_calm_selank_3mo',
    name: 'Calm Protocol – 3 Month',
    category: 'ot_research',
    price: 39900,
    description: 'Calm Protocol – 3 Month',
    slug: 'ot_calm_selank_3mo',
    months: 3,
    stripeProductId: 'prod_UDQB7TCKoSIGeh',
    stripePriceId: 'price_1TEzLxDQIH4O9FhrcXC36vKy',
  },

  // --- Comprehensive Fat Loss ---
  {
    id: 'ot_fat_loss_reta_5mg',
    name: 'Comprehensive Fat Loss – 5mg',
    category: 'ot_research',
    price: 29900,
    description: 'Comprehensive Fat Loss – 5mg',
    slug: 'ot_fat_loss_reta_5mg',
    months: 1,
    stripeProductId: 'prod_UDQEhTtUBoMANC',
    stripePriceId: 'price_1TEzO5DQIH4O9FhrTK5SGFcv',
  },
  {
    id: 'ot_fat_loss_reta_10mg',
    name: 'Comprehensive Fat Loss – 10mg',
    category: 'ot_research',
    price: 39900,
    description: 'Comprehensive Fat Loss – 10mg',
    slug: 'ot_fat_loss_reta_10mg',
    months: 3,
    stripeProductId: 'prod_UDQEhTtUBoMANC',
    stripePriceId: 'price_1TEzR3DQIH4O9FhrgIuGQDeN',
  },
  {
    id: 'ot_fat_loss_reta_20mg',
    name: 'Comprehensive Fat Loss – 20mg',
    category: 'ot_research',
    price: 74900,
    description: 'Comprehensive Fat Loss – 20mg',
    slug: 'ot_fat_loss_reta_20mg',
    months: 3,
    stripeProductId: 'prod_UDQEhTtUBoMANC',
    stripePriceId: 'price_1TEzRQDQIH4O9Fhrt8KV4DPO',
  },

  // --- Mitochondrial Reset ---
  {
    id: 'ot_mito_reset_1mo',
    name: 'Mitochondrial Reset – 1 Month',
    category: 'ot_research',
    price: 24900,
    description: 'Mitochondrial Reset – 1 Month',
    slug: 'ot_mito_reset_1mo',
    months: 1,
    stripeProductId: 'prod_UDQLHm5WUsuZHq',
    stripePriceId: 'price_1TEzVfDQIH4O9Fhr5zmnJfr8',
  },
  {
    id: 'ot_mito_reset_3mo',
    name: 'Mitochondrial Reset – 3 Month',
    category: 'ot_research',
    price: 57500,
    description: 'Mitochondrial Reset – 3 Month',
    slug: 'ot_mito_reset_3mo',
    months: 3,
    stripeProductId: 'prod_UDQLHm5WUsuZHq',
    stripePriceId: 'price_1TEzUODQIH4O9FhrpP74TMwP',
  },

  // --- Recomp Add-On – Ipa Solo ---
  {
    id: 'ot_recomp_ipa_3mo',
    name: 'Recomp Add-On – Ipa Solo – 3 Month',
    category: 'ot_research',
    price: 49900,
    description: 'Recomp Add-On – Ipa Solo – 3 Month',
    slug: 'ot_recomp_ipa_3mo',
    months: 3,
    stripeProductId: 'prod_UDQQZCDtv804nG',
    stripePriceId: 'price_1TEzZwDQIH4O9FhrIKCc7Fiy',
  },

  // --- Silver Recomp ---
  {
    id: 'ot_silver_recomp_1mo',
    name: 'Silver Recomp – 1 Month',
    category: 'ot_research',
    price: 29900,
    description: 'Silver Recomp – 1 Month',
    slug: 'ot_silver_recomp_1mo',
    months: 1,
    stripeProductId: 'prod_UDQXJ3iZwJZGKZ',
    stripePriceId: 'price_1TEzgNDQIH4O9FhrGyqyUWDH',
  },
];
...
const WEIGHT_LOSS: BillingPlan[] = [
  {
    ...
    price: 29900,
    description: 'Semaglutide 2.5mg/mL – 1 Month',
  ...
  },
  {
    ...
    category: 'ot_weight_loss',
    price: 84900,
    description: 'Semaglutide 2.5mg/mL – 3 Month',
...
const OTHER: BillingPlan[] = [
  {
    ...
    category: 'ot_other',
    price: 14900,
    description: 'Tadalafil 5mg – 1 Month',
  ...
  },
  {
    ...
    category: 'ot_other',
    price: 24900,
    description: 'Tadalafil 5mg – 3 Month',
  ...
  },
  {
    ...
    category: 'ot_other',
    price: 49800,
    description: 'Tadalafil 5mg – 6 Month',
  ...
  },
  {
    ...
    category: 'ot_other',
    price: 32900,
    description: 'GHK-Cu 1% Cream – 1 Month',
...
const BUNDLES: BillingPlan[] = [
  ...
  {
    id: 'ot_hw_1mo',
    name: 'Handsome and Wealthy (Enclo and NAD) – 1 Month',
    category: 'ot_bundles',
    price: 59900,
    description: 'Handsome and Wealthy (Enclo and NAD) – 1 Month',
    slug: 'ot_hw_1mo',
    months: 1,
    stripeProductId: 'prod_UDQmnuSWxnTqPs',
    stripePriceId: 'price_1TEzvEDQIH4O9FhruEEVaFrh',
  },
  {
    id: 'ot_hw_3mo',
    name: 'Handsome and Wealthy (Enclo and NAD) – 3 Month',
    category: 'ot_bundles',
    price: 161700,
    description: 'Handsome and Wealthy (Enclo and NAD) – 3 Month',
    slug: 'ot_hw_3mo',
    months: 3,
    isRecurring: true,
    stripeProductId: 'prod_UDQmnuSWxnTqPs',
    stripePriceId: 'price_1TEzwPDQIH4O9FhrdHzABHJl',
  },
  {
    id: 'ot_hw_6mo',
    name: 'Handsome and Wealthy (Enclo and NAD) – 6 Month',
    category: 'ot_bundles',
    price: 305300,
    description: 'Handsome and Wealthy (Enclo and NAD) – 6 Month',
    slug: 'ot_hw_6mo',
    months: 6,
    isRecurring: true,
    stripeProductId: 'prod_UDQmnuSWxnTqPs',
    stripePriceId: 'price_1TEzx9DQIH4O9FhrfynmC6uV',
  },
  {
    id: 'ot_hw_12mo',
    name: 'Handsome and Wealthy (Enclo and NAD) – 12 Month',
    category: 'ot_bundles',
    price: 575000,
    description: 'Handsome and Wealthy (Enclo and NAD) – 12 Month',
    slug: 'ot_hw_12mo',
    months: 12,
    isRecurring: true,
    stripeProductId: 'prod_UDQmnuSWxnTqPs',
    stripePriceId: 'price_1TEzxXDQIH4O9Fhr5TqvQqm5',
  },

  // --- Build Package ---
  {
    id: 'ot_build_1mo',
    name: 'Build Package – Enclo and Sermorelin – 1 Month',
    category: 'ot_bundles',
    price: 46900,
    description: 'Build Package – Enclo and Sermorelin – 1 Month',
    slug: 'ot_build_1mo',
    months: 1,
    stripeProductId: 'prod_UDQqoiKcGO17It',
    stripePriceId: 'price_1TEzzFDQIH4O9Fhro0VHP4ko',
  },
  {
    id: 'ot_build_3mo',
    name: 'Build Package – Enclo and Sermorelin – 3 Month',
    category: 'ot_bundles',
    price: 126800,
    description: 'Build Package – Enclo and Sermorelin – 3 Month',
    slug: 'ot_build_3mo',
    months: 3,
    isRecurring: true,
    stripeProductId: 'prod_UDQqoiKcGO17It',
    stripePriceId: 'price_1TEzzlDQIH4O9Fhrk5npznhz',
  },
  {
    id: 'ot_build_6mo',
    name: 'Build Package – Enclo and Sermorelin – 6 Month',
    category: 'ot_bundles',
    price: 239300,
    description: 'Build Package – Enclo and Sermorelin – 6 Month',
    slug: 'ot_build_6mo',
    months: 6,
    isRecurring: true,
    stripeProductId: 'prod_UDQqoiKcGO17It',
    stripePriceId: 'price_1TF003DQIH4O9FhrUOWithxY',
  },
  {
    id: 'ot_build_12mo',
    name: 'Build Package – Enclo and Sermorelin – 12 Month',
    category: 'ot_bundles',
    price: 450000,
    description: 'Build Package – Enclo and Sermorelin – 12 Month',
    slug: 'ot_build_12mo',
    months: 12,
    isRecurring: true,
    stripeProductId: 'prod_UDQqoiKcGO17It',
    stripePriceId: 'price_1TF00eDQIH4O9FhrglJNMlP6',
  },

  // --- Build Plus Package ---
  {
    id: 'ot_buildplus_1mo',
    name: 'Build Plus Package – Enclo, Sermorelin, Tadalafil – 1 Month',
    category: 'ot_bundles',
    price: 54900,
    description: 'Build Plus Package – Enclo, Sermorelin, Tadalafil – 1 Month',
    slug: 'ot_buildplus_1mo',
    months: 1,
    stripeProductId: 'prod_UDQuhMDeiT6oyH',
    stripePriceId: 'price_1TF02CDQIH4O9Fhr2SL5f0Ur',
  },
  {
    id: 'ot_buildplus_3mo',
    name: 'Build Plus Package – Enclo, Sermorelin, Tadalafil – 3 Month',
    category: 'ot_bundles',
    price: 148200,
    description: 'Build Plus Package – Enclo, Sermorelin, Tadalafil – 3 Month',
  ...
  {
    id: 'ot_buildplus_6mo',
    name: 'Build Plus Package – Enclo, Sermorelin, Tadalafil – 6 Month',
    category: 'ot_bundles',
    price: 280000,
    description: 'Build Plus Package – Enclo, Sermorelin, Tadalafil – 6 Month',
  ...
  {
    id: 'ot_buildplus_12mo',
    name: 'Build Plus Package – Enclo, Sermorelin, Tadalafil – 12 Month',
    category: 'ot_bundles',
    price: 530000,
    description: 'Build Plus Package – Enclo, Sermorelin, Tadalafil – 12 Month',
    slug: 'ot_buildplus_12mo',
    months: 12,
    isRecurring: true,
    stripeProductId: 'prod_UDQuhMDeiT6oyH',
  ...
  {
    id: 'ot_regen_3mo',
    name: 'Regen – NAD and Glutathione – 3 Month',
    category: 'ot_bundles',
    price: 122500,
    description: 'Regen – NAD and Glutathione – 3 Month',
    slug: 'ot_regen_3mo',
    months: 3,
    isRecurring: true,
    stripeProductId: 'prod_UDQym7ewYVXKab',
    stripePriceId: 'price_1TF069DQIH4O9FhruEmD4TFS',
  },
  {
    id: 'ot_regen_6mo',
    name: 'Regen – NAD and Glutathione – 6 Month',
    category: 'ot_bundles',
    price: 208200,
    description: 'Regen – NAD and Glutathione – 6 Month',
    slug: 'ot_regen_6mo',
    months: 6,
    isRecurring: true,
    stripeProductId: 'prod_UDQym7ewYVXKab',
    stripePriceId: 'price_1TF06uDQIH4O9FhrFQkbro4k',
  },
  {
    id: 'ot_regen_12mo',
    name: 'Regen – NAD and Glutathione – 12 Month',
    category: 'ot_bundles',
    price: 390000,
    description: 'Regen – NAD and Glutathione – 12 Month',
    slug: 'ot_regen_12mo',
    months: 12,
    isRecurring: true,
    stripeProductId: 'prod_UDQym7ewYVXKab',
    stripePriceId: 'price_1TF07yDQIH4O9Fhreck02d6r',
  },
];
