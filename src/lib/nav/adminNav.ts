...
export const baseAdminNavConfig: AdminNavItemConfig[] = [
  ...
  {
    path: '/admin/refill-queue',
    label: 'Membership / Refills',
    iconKey: 'RefreshCw',
    groupKey: 'memberships',
    groupLabel: 'Memberships',
    groupIconKey: 'RefreshCw',
  },
  {
    path: '/admin/subscription-renewals',
    label: 'Renewals',
    iconKey: 'CreditCard',
    groupKey: 'memberships',
  },
  {
    path: '/admin/finance/pending-profiles',
  ...
  {
    path: '/admin/vial-labels',
    label: 'Vial Labels',
    iconKey: 'ClipboardList',
    groupKey: 'orders',
  },
  {
    path: '/admin/addon-unmatched-sales',
    label: 'Addon Queue Gaps',
  ...
  { path: '/admin/products', label: 'Products', iconKey: 'Store' },
  {
    ...
    groupIconKey: 'TrendingUp',
  },
  { path: '/admin/results', label: 'Results', iconKey: 'Award', groupKey: 'reporting' },
  {
    path: '/admin/reports/telehealth-compensation',
    label: 'Telehealth Payouts',
    iconKey: 'Video',
    groupKey: 'reporting',
  },
  {
