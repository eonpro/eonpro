 ...
 */
export async function getSecret(secretId: string, property?: string): Promise<string> {
  // Check cache first
...
export async function initializeSecrets(): Promise<void> {
  ...
  const criticalSecrets = ['eonpro/prod/auth', 'eonpro/prod/encryption', 'eonpro/prod/database'];
