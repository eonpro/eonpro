...
// ============================================================================
// Search Index Self-Healing (server-only — see search-index-heal.ts)
// ============================================================================
// healPatientSearchIndex lives in @/lib/utils/search-index-heal.ts to avoid
// pulling Node.js crypto into client/edge bundles via the phi-encryption dep.
