...
export const COMMON_ALLERGENS: Allergen[] = [
  ...
  { name: 'Sulfa drugs', category: 'drug', aliases: ['sulfonamide', 'sulfa', 'sulfamethoxazole', 'Bactrim', 'Septra'], drugClass: 'sulfonamide' },
  { name: 'Aspirin', category: 'drug', aliases: ['ASA', 'acetylsalicylic acid'], drugClass: 'NSAID' },
  ...
  { name: 'NSAIDs', category: 'drug', aliases: ['non-steroidal anti-inflammatory'], drugClass: 'NSAID' },
  ...
  { name: 'Cephalosporins', category: 'drug', aliases: ['cephalexin', 'Keflex', 'ceftriaxone'], drugClass: 'cephalosporin' },
  { name: 'Erythromycin', category: 'drug', aliases: ['E-Mycin'], drugClass: 'macrolide' },
  { name: 'Azithromycin', category: 'drug', aliases: ['Zithromax', 'Z-pack'], drugClass: 'macrolide' },
  { name: 'Clarithromycin', category: 'drug', aliases: ['Biaxin'], drugClass: 'macrolide' },
  { name: 'Fluoroquinolones', category: 'drug', aliases: ['ciprofloxacin', 'Cipro', 'levofloxacin', 'Levaquin'], drugClass: 'fluoroquinolone' },
  { name: 'Tetracycline', category: 'drug', aliases: ['doxycycline', 'minocycline'], drugClass: 'tetracycline' },
  ...
  { name: 'ACE inhibitors', category: 'drug', aliases: ['lisinopril', 'enalapril', 'ramipril', 'benazepril'], drugClass: 'ACE inhibitor' },
  { name: 'Statins', category: 'drug', aliases: ['atorvastatin', 'Lipitor', 'rosuvastatin', 'Crestor', 'simvastatin'], drugClass: 'statin' },
  { name: 'Metformin', category: 'drug', aliases: ['Glucophage'], drugClass: 'biguanide' },
  { name: 'Insulin', category: 'drug', aliases: ['Humalog', 'Novolog', 'Lantus'], drugClass: 'insulin' },
  { name: 'Latex', category: 'drug', aliases: ['latex gloves', 'natural rubber latex'], drugClass: 'latex' },
  { name: 'Iodine', category: 'drug', aliases: ['Betadine', 'povidone-iodine'], drugClass: 'iodine' },
  { name: 'Contrast dye', category: 'drug', aliases: ['IV contrast', 'CT contrast', 'iodinated contrast', 'gadolinium'], drugClass: 'contrast' },
  ...
  { name: 'Benzodiazepines', category: 'drug', aliases: ['diazepam', 'Valium', 'lorazepam', 'Ativan', 'alprazolam', 'Xanax'], drugClass: 'benzodiazepine' },
  ...
  { name: 'Semaglutide', category: 'drug', aliases: ['Ozempic', 'Wegovy', 'Rybelsus'], drugClass: 'GLP-1 agonist' },
  { name: 'Tirzepatide', category: 'drug', aliases: ['Mounjaro', 'Zepbound'], drugClass: 'GLP-1/GIP agonist' },
  { name: 'Liraglutide', category: 'drug', aliases: ['Victoza', 'Saxenda'], drugClass: 'GLP-1 agonist' },
  { name: 'Testosterone', category: 'drug', aliases: ['TRT', 'testosterone cypionate', 'AndroGel'], drugClass: 'androgen' },
  ...
  { name: 'Heparin', category: 'drug', aliases: ['Lovenox', 'enoxaparin'], drugClass: 'anticoagulant' },
  { name: 'SSRIs', category: 'drug', aliases: ['sertraline', 'Zoloft', 'fluoxetine', 'Prozac', 'escitalopram', 'Lexapro'], drugClass: 'SSRI' },
  { name: 'Allopurinol', category: 'drug', aliases: ['Zyloprim'], drugClass: 'xanthine oxidase inhibitor' },
  { name: 'Methotrexate', category: 'drug', aliases: ['MTX', 'Trexall'], drugClass: 'antimetabolite' },
  { name: 'Hydroxychloroquine', category: 'drug', aliases: ['Plaquenil'], drugClass: 'antimalarial' },

  // ── Food Allergies ──
  { name: 'Peanuts', category: 'food', aliases: ['peanut', 'groundnut'] },
  { name: 'Tree nuts', category: 'food', aliases: ['almonds', 'walnuts', 'cashews', 'pecans', 'pistachios', 'hazelnuts', 'macadamia'] },
  { name: 'Shellfish', category: 'food', aliases: ['shrimp', 'crab', 'lobster', 'clam', 'mussel', 'oyster'] },
  ...
  { name: 'Sulfites', category: 'food', aliases: ['sulfite', 'sodium sulfite', 'sodium bisulfite'] },
  ...
  { name: 'Pollen', category: 'environmental', aliases: ['hay fever', 'ragweed', 'grass pollen', 'tree pollen'] },
  ...
  { name: 'Pet dander', category: 'environmental', aliases: ['cat dander', 'dog dander', 'animal dander'] },
  { name: 'Bee stings', category: 'environmental', aliases: ['bee venom', 'wasp stings', 'hornet', 'yellow jacket'] },
  ...
  { name: 'Poison ivy', category: 'environmental', aliases: ['poison oak', 'poison sumac', 'urushiol'] },
  { name: 'Formaldehyde', category: 'environmental', aliases: [] },
  { name: 'Fragrances', category: 'environmental', aliases: ['perfume', 'cologne', 'scented products'] },
];
