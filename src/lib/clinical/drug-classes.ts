...
export const DRUG_CLASSES: DrugClassEntry[] = [
  {
    ...
    members: ['penicillin', 'amoxicillin', 'ampicillin', 'piperacillin', 'nafcillin', 'oxacillin', 'dicloxacillin', 'augmentin', 'amoxicillin/clavulanate', 'ampicillin/sulbactam', 'piperacillin/tazobactam', 'unasyn', 'zosyn'],
    crossReactive: ['cephalosporin'],
  },
  {
    className: 'cephalosporin',
    members: ['cephalexin', 'cefazolin', 'ceftriaxone', 'cefdinir', 'cefuroxime', 'ceftazidime', 'cefepime', 'cefpodoxime', 'cefixime', 'keflex', 'ancef', 'rocephin', 'omnicef'],
    crossReactive: ['penicillin'],
  },
  {
    className: 'sulfonamide',
    members: ['sulfamethoxazole', 'sulfasalazine', 'sulfadiazine', 'bactrim', 'septra', 'trimethoprim/sulfamethoxazole'],
  },
  {
    className: 'NSAID',
    members: ['aspirin', 'ibuprofen', 'naproxen', 'diclofenac', 'indomethacin', 'ketorolac', 'meloxicam', 'piroxicam', 'celecoxib', 'advil', 'motrin', 'aleve', 'voltaren', 'toradol', 'mobic', 'celebrex'],
  },
  {
    className: 'opioid',
    members: ['codeine', 'morphine', 'hydrocodone', 'oxycodone', 'fentanyl', 'tramadol', 'hydromorphone', 'methadone', 'meperidine', 'buprenorphine', 'vicodin', 'norco', 'percocet', 'oxycontin', 'dilaudid', 'demerol', 'ultram', 'suboxone'],
  },
  {
    className: 'macrolide',
  ...
  },
  {
    ...
    members: ['ciprofloxacin', 'levofloxacin', 'moxifloxacin', 'ofloxacin', 'cipro', 'levaquin', 'avelox'],
  },
  {
  ...
  {
    className: 'statin',
    members: ['atorvastatin', 'rosuvastatin', 'simvastatin', 'pravastatin', 'lovastatin', 'fluvastatin', 'pitavastatin', 'lipitor', 'crestor', 'zocor'],
  },
  {
    className: 'ACE inhibitor',
    members: ['lisinopril', 'enalapril', 'ramipril', 'benazepril', 'captopril', 'fosinopril', 'quinapril', 'trandolapril', 'perindopril', 'prinivil', 'zestril', 'vasotec', 'altace'],
  },
  {
    className: 'ARB',
    members: ['losartan', 'valsartan', 'irbesartan', 'candesartan', 'olmesartan', 'telmisartan', 'azilsartan', 'cozaar', 'diovan', 'avapro'],
  },
  {
    className: 'benzodiazepine',
    members: ['diazepam', 'lorazepam', 'alprazolam', 'clonazepam', 'midazolam', 'temazepam', 'triazolam', 'valium', 'ativan', 'xanax', 'klonopin'],
  },
  {
    className: 'SSRI',
    members: ['sertraline', 'fluoxetine', 'escitalopram', 'citalopram', 'paroxetine', 'fluvoxamine', 'zoloft', 'prozac', 'lexapro', 'celexa', 'paxil'],
  },
  {
    className: 'anticoagulant',
    members: ['warfarin', 'heparin', 'enoxaparin', 'apixaban', 'rivaroxaban', 'dabigatran', 'coumadin', 'lovenox', 'eliquis', 'xarelto', 'pradaxa'],
  },
  {
    className: 'GLP-1 agonist',
    members: ['semaglutide', 'tirzepatide', 'liraglutide', 'dulaglutide', 'exenatide', 'ozempic', 'wegovy', 'rybelsus', 'mounjaro', 'zepbound', 'victoza', 'saxenda', 'trulicity', 'byetta', 'bydureon'],
  },
  {
    className: 'local anesthetic',
    members: ['lidocaine', 'bupivacaine', 'ropivacaine', 'mepivacaine', 'procaine', 'novocaine', 'xylocaine', 'marcaine'],
  },
  {
    className: 'contrast',
    members: ['iodinated contrast', 'gadolinium', 'IV contrast', 'CT contrast', 'MRI contrast', 'contrast dye'],
  },
];
...
export function checkAllergyDrugClass(
  ...
  for (const entry of DRUG_CLASSES) {
    const medInClass = entry.members.some((m) => medLower.includes(m.toLowerCase())) ||
