...
export const ROLE_PERMISSIONS = {
  ...
  SALES_REP: [
    // Full Patient Management (admin-level within patient profiles)
    PERMISSIONS.PATIENT_CREATE,
    PERMISSIONS.PATIENT_READ,
    PERMISSIONS.PATIENT_UPDATE,
    PERMISSIONS.PATIENT_DELETE,
    ...
    PERMISSIONS.PATIENT_VIEW_PHI,
    PERMISSIONS.PATIENT_MERGE,
    PERMISSIONS.SALES_REP_VIEW_ALL_PATIENTS,
    ...
    // SOAP Notes (view and create, no delete/lock)
    PERMISSIONS.SOAP_CREATE,
    PERMISSIONS.SOAP_READ,
    PERMISSIONS.SOAP_UPDATE,

    // Billing (view only — no company-level financial operations)
    PERMISSIONS.BILLING_VIEW,
