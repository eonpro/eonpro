...
export const TIRZEPATIDE_ENHANCED_TEMPLATES: EnhancedSigTemplate[] = [
  ...
  },
  {
    ...
    phase: 'maintenance',
    targetDose: '15 mg',
    sig: 'Inject 15 mg (150 units) subcutaneously once weekly.',
    quantity: '1',
    refills: '2',
    daysSupply: 28,
    storage: STORAGE_PRESETS.REFRIGERATED_GLP1,
...
const TIRZEPATIDE_30MG_ENHANCED_TEMPLATES: EnhancedSigTemplate[] = [
  ...
  },
  {
    ...
    weekRange: '9-12',
    targetDose: '7.5 mg',
    sig: 'Inject 7.5 mg (25 units) subcutaneously once weekly.',
    quantity: '1',
    refills: '0',
    daysSupply: 28,
    storage: STORAGE_PRESETS.REFRIGERATED_GLP1,
...
export const SEMAGLUTIDE_ENHANCED_TEMPLATES: EnhancedSigTemplate[] = [
  ...
  },
  {
    ...
    phase: 'maintenance',
    targetDose: '2.4 mg',
    sig: 'Inject 2.4 mg (96 units) subcutaneously once weekly.',
    quantity: '1',
    refills: '2',
    daysSupply: 28,
    storage: STORAGE_PRESETS.REFRIGERATED_GLP1,
...
export const TESTOSTERONE_ENHANCED_TEMPLATES: EnhancedSigTemplate[] = [
  ...
  },
  {
    ...
    phase: 'standard',
    targetDose: '80 mg',
    sig: 'Inject 80 mg (40 units) subcutaneously once weekly.',
    quantity: '10',
    refills: '2',
    daysSupply: 87,
    storage: STORAGE_PRESETS.TESTOSTERONE,
