...
export const WELLMEDR_INTAKE_SECTIONS = [
  {
    ...
    fields: [
      ...
      { id: "patient-gender", label: "Gender", aliases: ["sex", "biologicalsex", "biological-sex", "biological sex"] },
  ...
  },
  {
    ...
    fields: [
      { 
        ...
        aliases: ["startingweight", "currentweight", "current weight", "current-weight", "current weight (lbs)"],
        inputType: "text", 
      ...
      { 
        id: "idealWeight", 
        label: "Ideal Weight", 
        aliases: ["idealweight", "goalweight", "targetweight", "goal-weight", "goal weight", "goal weight (lbs)"],
        inputType: "text", 
      ...
      { 
        ...
        aliases: ["heightfeet", "heightinches", "feet", "inches", "height (feet)", "height (inches)"],
        inputType: "text", 
        placeholder: "e.g., 5'8\"" 
      },
      { 
      ...
      { 
        ...
        aliases: [
          "bloodpressure", "bp", "avg-blood-pressure-range", "avgbloodpressurerange",
          "average blood pressure range", "averagebloodpressurerange"
        ],
        inputType: "text", 
      ...
      { 
        ...
        aliases: [
          "avg-resting-heart-rate", "avgrestingheartrate", "restingheartrate",
          "average resting heart rate", "averagerestingheartrate", "heart rate"
        ],
        inputType: "text", 
  ...
  },
  {
    ...
    fields: [
      { 
        ...
        aliases: [
          "medicalconditions", "conditions", "health-conditions", "healthconditions",
          "primary health conditions", "primaryhealthconditions", "health conditions"
        ],
        inputType: "textarea", 
      ...
      { 
        ...
        aliases: [
          "health-conditions-2", "healthconditions2", "secondary health conditions",
          "secondaryhealthconditions", "otherconditions"
        ],
        inputType: "textarea", 
      ...
      { 
        ...
        aliases: [
          "currentmedications", "medications", "current-meds", "currentmeds",
          "current medication list", "currentmedicationlist", "current-meds-details",
          "currentmedsdetails"
        ],
        inputType: "textarea", 
      ...
      { 
        ...
        aliases: [
          "surgicalhistory", "surgeries", "bariatric", "bariatric-details",
          "bariatricdetails", "prior bariatric surgery", "priorbariatricsurgery"
        ],
        inputType: "textarea", 
      ...
      { 
        ...
        aliases: [
          "weight-related-symptoms", "weightrelatedsymptoms", "weight related symptoms"
        ],
        inputType: "textarea", 
      ...
      { 
        ...
        label: "Opioid Use", 
        aliases: [
          "opioids", "opioid-use", "opioiduse", "opioids-details", "opioidsdetails"
        ],
        inputType: "select", 
  ...
  },
  {
    ...
    fields: [
      { 
        ...
        aliases: [
          "pregnancystatus", "pregnant", "reproductive-status", "reproductivestatus",
          "reproductive status"
        ],
        inputType: "select", 
        options: ["Not Pregnant", "Pregnant", "Trying to Conceive", "Breastfeeding", "None of the below", "N/A"] 
      },
      { 
        id: "hasDiabetes", 
        label: "Has Diabetes", 
        aliases: [
          "hasdiabetes", "diabetes", "type2diabetes", "type-2-diabetes",
          "type 2 diabetes"
        ],
        inputType: "select", 
      ...
      { 
        ...
        aliases: [
          "men2-history", "men2history", "men2 history", "men2historyglp1contraindication",
      ...
      { 
        ...
        aliases: [
          "bariatric", "prior-bariatric-surgery", "priorbariatricsurgery",
  ...
  },
  {
    ...
    fields: [
      { 
        ...
        aliases: [
          "mentalhealthhistory", "mentalhealth", "mentalHealthConditions", 
          "psychiatrichistory", "anxietydepression", "mentalhealthdiagnosis"
        ],
        inputType: "textarea", 
  ...
  },
  {
    ...
    fields: [
      ...
      { 
        ...
        aliases: [
          "glp1-last-30", "glp1last30", "glp1 last 30", "used glp-1 in last 30 days",
      ...
      { 
        ...
        aliases: [
          "glp1type", "currentglp1medication", "currentglp1",
          "glp1-last-30-medication-type", "glp1last30medicationtype",
          "recent glp-1 medication type"
        ],
        inputType: "select", 
        options: ["None", "Semaglutide (Ozempic/Wegovy)", "Tirzepatide (Mounjaro/Zepbound)", "Liraglutide (Saxenda)", "Other"] 
      },
      { 
        id: "medicationPreference", 
        label: "Medication Preference", 
        aliases: [
          "medicationpreference", "preferred-meds", "preferredmeds",
          "preferred medication", "preferredmedication"
        ],
        inputType: "select", 
      ...
      { 
        ...
        aliases: [
          "injections-tablets", "injectionstablets", "injection vs tablet preference",
      ...
      { 
        ...
        aliases: [
          "semaglutidedosage", "semaglutidedose",
      ...
      { 
        ...
        aliases: [
          "affordability-potency", "affordabilitypotency", 
          "budget vs potency preference", "budgetvspotencypreference"
        ],
        inputType: "select", 
  ...
  },
  {
    ...
    fields: [
      ...
      { 
        ...
        label: "Health Goals", 
        aliases: [
          "healthgoals", "goals", "primary-fitness-goal", "primaryfitnessgoal",
      ...
      { 
        ...
        aliases: [
          "weight-loss-motivation", "weightlossmotivation", "weight loss motivation"
        ],
        inputType: "textarea", 
      ...
      { 
        ...
        aliases: [
          "motivation-level", "motivationlevel", "motivation level"
        ],
        inputType: "select", 
      ...
      { 
        ...
        aliases: [
          "pace", "preferred-weight-loss-pace", "preferredweightlosspace",
      ...
      { 
        ...
        aliases: [
          "additional-info", "additionalinfo", "additional-info-details",
          "additionalinfodetails", "additional information to disclose",
  ...
  },
  {
    ...
    fields: [
      ...
      { 
        ...
        aliases: [
          "hipaaconsent", "hipaa", "hipaaauthorizationaccepted",
          "hipaa-agreement", "hipaagree", "hipaa agreement"
        ],
        inputType: "text" 
      },
      // Privacy & Terms
      { 
        ...
        aliases: [
          "privacypolicyconsent", "privacypolicy", "acceptedprivacy", 
      ...
      { 
        ...
        aliases: [
          "termsconsent", "termsandconditions", "acceptedterms", 
          "termsofuseaccepted"
        ],
        inputType: "text" 
      },
      ...
      { 
        ...
        label: "SMS Consent", 
        aliases: [
          "smsconsent", "sms", "communicationconsent", "smsconsentaccepted"
        ],
        inputType: "text" 
      },
      { 
      ...
      { 
        ...
        aliases: [
          "cancellationpolicyconsent", "cancellationpolicy", 
      ...
      { 
        ...
        aliases: [
          "medicalweightconsent", "weightlossconsent", 
      ...
      { 
        ...
        aliases: [
          "checkout completed", "checkoutcompleted", "checkout-completed",
 ...
 */
export function getIntakeSectionsForClinic(clinicSubdomain?: string | null): typeof WELLMEDR_INTAKE_SECTIONS {
