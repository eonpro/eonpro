      ...
      <div className="border-b bg-white px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-600">Manage patient issues and support requests</p>
          </div>
          <button
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-1/3 overflow-y-auto border-r bg-white">
          {loading ? (
            ...
            <div className="p-6 text-center">
              ...
              <p className="mt-1 text-sm text-gray-500">Create a new ticket to get started</p>
            </div>
          ) : (
            filteredTickets.map((ticket) => (
              <button
                ...
                className={`w-full border-b p-4 text-left transition-colors hover:bg-gray-50 ${
                  selectedTicket?.id === ticket.id ? 'border-l-4 border-l-blue-600 bg-blue-50' : ''
                }`}
              >
                <div className="mb-1 flex items-start justify-between">
                  ...
                  <span
                    className={`rounded-full px-2 py-1 text-xs ${getStatusColor(ticket.status)}`}
                  >
        ...
        {selectedTicket ? (
          <div className="flex-1 overflow-y-auto bg-white">
            <TicketDetailView ticketId={selectedTicket.id} currentUserId={currentUserId} />
          </div>
        ) : (
          <div className="flex flex-1 items-center justify-center bg-gray-50">
            <div className="text-center">
              <Ticket className="mx-auto mb-4 h-16 w-16 text-gray-300" />
              <h3 className="mb-1 text-lg font-medium text-gray-900">Select a ticket</h3>
                ...
                <div>
                    ...
                    {newTicket.patientId && (
                      <div className="mt-2 rounded-lg border border-green-200 bg-green-50 p-2">
                        <p className="text-sm text-green-800">
                          ...
                          <span className="font-semibold">
                            {
                              patients.find((p) => p.id === parseInt(newTicket.patientId))
                                ?.firstName
                            }{' '}
                  ...
                  <div className="mt-2 flex items-center justify-between">
                    <p className="text-xs text-gray-500">
                      Title format:{' '}
                      <span className="font-semibold">[Client Name] - [Category]</span>
                    </p>
                    <a
                      href="/patients"
                      target="_blank"
