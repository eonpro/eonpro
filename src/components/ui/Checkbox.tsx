      ...
      >
        ...
        {(label || description) && (
          <div className="min-w-0 flex-1">
            ...
            {description && (
              <span id={descriptionId} className="mt-0.5 block text-sm text-gray-500">
                {description}
              </span>
            )}
          </div>
      ...
      <div className="relative flex-shrink-0">
        ...
        >
          ...
          {showStatus && size !== 'sm' && (
            <span
              className={cn(
                'absolute inset-0 flex items-center text-[9px] font-bold uppercase text-white',
        ...
        <div
          className={cn(
            thumb,
            'absolute left-0.5 top-0.5 rounded-full bg-white shadow-md',
