    ...
    fields: [
      {
        ...
        aliases: ['startingweight', 'currentweight', 'current_weight'],
        inputType: 'text',
      ...
      },
      {
        id: 'idealWeight',
        label: 'Ideal Weight',
        aliases: ['idealweight', 'goalweight', 'targetweight', 'ideal_weight'],
        inputType: 'text',
      ...
      },
      {
        id: 'height',
        label: 'Height',
        aliases: ['height_feet', 'height_inches', 'heightfeet', 'heightinches'],
        inputType: 'text',
        placeholder: 'e.g., 5\'8"',
      },
      {
      ...
      },
      {
        ...
        aliases: ['bloodpressure', 'bp', 'blood_pressure'],
        inputType: 'text',
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        inputType: 'textarea',
        placeholder: 'e.g., IBS, GERD, Celiac...',
      },
      {
        id: 'kidneyConditions',
    ...
    fields: [
      {
        ...
        aliases: ['pregnancystatus', 'pregnant', 'pregnancy_status'],
        inputType: 'select',
    ...
    fields: [
      {
        ...
        aliases: ['activitylevel', 'physicalactivity', 'dailyphysicalactivity', 'activity_level'],
        inputType: 'select',
        options: [
          'Sedentary',
          'Lightly Active',
      ...
      },
      {
        ...
        aliases: ['recreationaldrugs', 'recreationaldruguse', 'druguse', 'recreational_drugs'],
        inputType: 'textarea',
      ...
      },
      {
        ...
        aliases: ['weightlosshistory', 'weight_loss_methods', 'weightlossmethods'],
        inputType: 'textarea',
        placeholder: 'Previous weight loss attempts...',
      },
      {
        id: 'weightLossSupport',
        label: 'Weight Loss Support Preferences',
        aliases: ['weightlosssupport', 'weight_loss_support', 'supportpreferences'],
        inputType: 'textarea',
        placeholder: 'e.g., Nutrition coaching, Meal planning...',
      },
      {
        id: 'dosageInterest',
        label: 'Personalized Dosage Interest',
        aliases: ['dosageinterest', 'dosage_interest'],
        inputType: 'select',
      ...
      },
      {
        ...
        aliases: ['commonsideeffects', 'common_side_effects', 'sideeffectconcerns'],
        inputType: 'text',
        placeholder: 'e.g., Gastrointestinal, Fatigue...',
      },
    ],
  },
  {
    ...
    fields: [
      {
        ...
        aliases: ['glp1history', 'glp1medicationhistory', 'glp1_history'],
        inputType: 'select',
        options: ['Never Used', 'Currently Using', 'Previously Used', 'Considering'],
      },
      {
        id: 'glp1Type',
        label: 'Current GLP-1 Medication',
        aliases: ['glp1type', 'currentglp1medication', 'currentglp1', 'glp1_type'],
        inputType: 'select',
        options: [
          'None',
      ...
      },
      {
        ...
        aliases: ['medicationpreference', 'medication_preference'],
        inputType: 'select',
      ...
      },
      {
        ...
        aliases: ['semaglutidedosage', 'semaglutidedose', 'semaglutide_dosage'],
        inputType: 'text',
      ...
      },
      {
        ...
        aliases: ['semaglutsideseffects', 'semaglutide_side_effects', 'semaglutidesideeffects'],
        inputType: 'textarea',
      ...
      },
      {
        ...
        aliases: ['semaglutidesuccess', 'semaglutide_success'],
        inputType: 'select',
      ...
      },
      {
        ...
        aliases: ['tirzepatidedosage', 'tirzepatidedose', 'tirzepatide_dosage'],
        inputType: 'text',
      ...
      },
      {
        ...
        aliases: ['tirzepatidesideeffects', 'tirzepatide_side_effects'],
        inputType: 'textarea',
      ...
      },
      {
        ...
        aliases: ['tirzepatidesuccess', 'tirzepatide_success'],
        inputType: 'select',
        options: ['Very Successful', 'Somewhat Successful', 'Not Successful', 'Hard to Stay Consistent'],
      },
      {
        ...
        aliases: ['dosagesatisfaction', 'dosage_satisfaction'],
        inputType: 'select',
