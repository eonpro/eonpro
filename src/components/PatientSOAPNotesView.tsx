      ...
      <div className="space-y-4">
        {(() => {
          ...
          return filteredNotes.map((note: any) => (
            <div
              key={note.id}
              className="cursor-pointer rounded-lg border bg-white p-4 transition-shadow hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-[var(--brand-primary)] md:p-6"
              ...
              <div className="mb-3 flex flex-col gap-2 sm:mb-4 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {note.sourceType === 'TELEHEALTH_SCRIBE' ? (
