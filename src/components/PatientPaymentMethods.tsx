                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="font-medium">
                        ...
                        {card.isDefault && (
                          <span className="ml-2 text-xs bg-[#4fa77e] text-white px-2 py-0.5 rounded">
                            Default
                          </span>
                        )}
                      </div>
            ...
            <form onSubmit={handleAddCard} className="space-y-4">
              ...
              <div className="flex gap-3">
                <button
                  type="submit"
                  disabled={submitting}
                  className="px-4 py-2 bg-[#4fa77e] text-white rounded-lg hover:bg-[#3f8660] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
      ...
      <div className="bg-gray-50 rounded-lg p-4 text-sm text-gray-600">
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p className="mt-1">
              Card numbers are encrypted using AES-256-GCM encryption and stored securely. 
              Only the last 4 digits are displayed. CVV codes are never stored after processing.
            </p>
          </div>
        </div>
      </div>
