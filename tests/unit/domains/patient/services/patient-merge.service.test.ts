...
vi.mock('@/lib/db', () => {
  return {
    prisma: {
      ...
      paymentMethod: { updateMany: vi.fn(), findMany: vi.fn() },
...
const createMockPrisma = () => ({
  ...
  invoice: { updateMany: vi.fn() },
  payment: { updateMany: vi.fn() },
  paymentMethod: { updateMany: vi.fn(), findMany: vi.fn().mockResolvedValue([]) },
  subscription: { updateMany: vi.fn() },
  sOAPNote: { updateMany: vi.fn() },
  patientDocument: { updateMany: vi.fn() },
  intakeFormSubmission: { updateMany: vi.fn() },
  ...
  hIPAAAuditEntry: { updateMany: vi.fn() },
  phoneOtp: { updateMany: vi.fn() },
  patientNote: { updateMany: vi.fn() },
  patientSalesRepAssignment: { updateMany: vi.fn() },
  refillQueue: { updateMany: vi.fn() },
