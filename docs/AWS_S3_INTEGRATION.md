...
| Constant                     | Value                                  | Why                                                                                                                                                                                                                                                                                                                                                                                     |
| ---------------------------- | -------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `MMS_MAX_BYTES`              | 10 MB                                  | Above Twilio's recommended US-carrier ceiling of 5 MB. Twilio's API accepts up to 10 MB, but a non-trivial fraction of US carriers (AT&T / Verizon / T-Mobile) may strip or downscale media above 5 MB before delivery. Trade-off accepted to give staff more room for high-resolution clinical photos; carrier-failed messages are marked FAILED via the existing Twilio webhook path. |
