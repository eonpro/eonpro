...
## Problem
Prescriptions require a shipping address, but the WellMedR Airtable automation may not be sending address fields to the webhook.

## Solution: Configure Airtable Automation

In your Airtable automation that calls `/api/webhooks/wellmedr-invoice`, ensure you include the address fields in the POST body.
...
If you can't modify the Airtable automation, you can manually update patient addresses in the admin panel:
