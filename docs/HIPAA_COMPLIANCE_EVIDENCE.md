...
This document provides evidence of HIPAA compliance controls implemented in the EONPRO Telehealth Platform. Each requirement references specific code, configuration, or documentation.
...
This document certifies that the technical controls listed above have been implemented in the EONPRO Telehealth Platform codebase as of the date indicated.
