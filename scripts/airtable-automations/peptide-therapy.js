// ═══════════════════════════════════════════════════════════════════
// EONPRO Webhook — OT Mens: Peptide Therapy
// Sends new intake records to ot.eonpro.io with affiliate tracking
// ═══════════════════════════════════════════════════════════════════

let inputConfig = input.config();

let table = base.getTable("OT Mens - Peptide Therapy");
...
// Heyflow populates these automatically. They carry ?ref=CODE which
// is the primary mechanism for affiliate attribution.
...
if (missingUrlFields.length > 0) {
    ...
    // Re-read the record (Heyflow may have populated fields after initial creation)
...
payload['treatmentType'] = 'peptides';
